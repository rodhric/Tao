...
def ben():
    ...
    1- def qi
        + b1 ou b2 = colapso
    '''
#                                                                          rápido        DERTECTANDO FC
# -------------------------------------- PULSO LENTO OU RÁPIDO VIA FC
        while True:
            try:
