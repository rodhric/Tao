            ...
            if "*" in doc:
                ...
                if len(seta) != 0:
                    ...
                    if index >= 3 and index < 4:
                        index = int(index)
                    cls()
                    print("\n\n\n\n ℞ FAZENDO A PRESCRIÇÃO DE ACUPUNTURA...\n\n")
                    print('[▬▬        ]\n')  
                    print('SEPARANDO O PERFIL DO PACIENTE\n\n')                                               
                    time.sleep(1.7)
                    cls()
                    print("\n\n\n\n ℞ FAZENDO A PRESCRIÇÃO DE ACUPUNTURA...\n\n")
                    print('[▬▬▬▬▬        ]\n')                             
                    print('DEFININDO MÉTODOS E QUANTIDADES DE PONTOS\n\n')
                    time.sleep(0.9)                    
                    cls()
                    print("\n\n\n\n ℞ FAZENDO A PRESCRIÇÃO DE ACUPUNTURA...\n\n")
                    print('[▬▬▬▬▬▬▬▬     ]\n')                                   
                    print('REFINANDO PONTOS SEGUNDO ORIENTAÇÕES COLETADAS\n\n')              
                    time.sleep(1.6)                  
                    cls()
                    print("\n\n\n\n ℞ FAZENDO A PRESCRIÇÃO DE ACUPUNTURA...\n\n")
                    print('[▬▬▬▬▬▬▬▬▬▬▬  ]\n')                                                 
            ...
            if len(seta) < 1:
                ...
                if digprepre.isnumeric() == True:
                    ...
                    if "FIM" in digpre:
                        ...
                        print('[▬▬        ]\n')  
                        print('REGISTRANDO DADOS E CADASTRO...')                                               
                        print('\n\n')
                        time.sleep(1.7)                        
                        cls()
                        print("\n\n\n\n SALVANDO EM BANCO DE DADOS...\n\n")
                        print('[▬▬▬▬      ]\n')                          
                        print('SALVANDO DADOS SENSÍVEIS SEPARADAMENTE...')                                               
                        print('\n\n')
                        time.sleep(2.0)                        
                        cls()
                        print("\n\n\n\n SALVANDO EM BANCO DE DADOS...\n\n")
                        print('[▬▬▬▬▬▬    ]\n')                          
                        print('SALVANDO PRESCRIÇÃO...')                                               
                        print('\n\n')
                        time.sleep(1.4)   
                        cls()
                        print("\n\n\n\n SALVANDO EM BANCO DE DADOS...\n\n")
                        print('[▬▬▬▬▬▬▬▬  ]\n')                                                  
                        print('APRENDENDO O DIAGNÓSTICO POR AI...')                                               
                        print('\n\n')
                        time.sleep(2.0)                                                                                                        
                        if homm == 'A':
                            ...
                            data = [
                                "'" + str(cpf) + "'", str(nome), str(horadia), str(addr).upper(), "'" + str(hda) + "'"]
                            with open(
                        ...
                        print('\n')
                        time.sleep(1.2)                                                                                     
                        print('PRESCRIÇÕES: {}MB'.format(str(os1)))
                        print('BASE DE INTELIGÊNCIA ARTIFICIAL: {}MB'.format(str(os2)))
                        print('PRONTUÁRIOS: {}MB'.format(str(os3)))
                        print('BANCO DE CADASTRO: {}MB'.format(str(os4)))
                        print()
                        time.sleep(2)
                        print('\nREABRINDO ESTA PRESCRIÇÃO SALVA...')                           
                        time.sleep(2)                        
                        ler()
                    else:
