                    ...
                    while True:
                        try:
                            ...
                            if len(ddtot) == 10 and ddtot.isnumeric() == False:
                                ...
                                sufte=int(pro_especcodcompa_dn[1])
                                if sufte==1:
                                    suf='A'
                                elif sufte==2:
                                    suf='B'
...
def ben():
    ...
    """
        ...
        pul = [
            {"ANÁLISE": "METAL", "⚌": yt(d1a), "XUE": yt(d1b), "⚏": yt(d1c)},
            {"ANÁLISE": "TERRA", "⚌": yt(d2a), "XUE": yt(d2b), "⚏": yt(d2c)},
            {"ANÁLISE": "MINISTERIAL","⚌": yt(d3a),"XUE": yt(d3b),"⚏": yt(d3c)},
            {"ANÁLISE": "IMPERIAL","⚌": yt(e1a),"XUE": yt(e1b),"⚏": yt(e1c)},
            {"ANÁLISE": "MADEIRA", "⚌": yt(e2a), "XUE": yt(e2b), "⚏": yt(e2c)},
            {"ANÁLISE": "ÁGUA", "⚌": yt(e3a), "XUE": yt(e3b), "⚏": yt(e3c)},
        ]
        pul2 = [
...
atualizações = {
    ...
    'TAO 5.2.9': 'AJUSTES DE ERROS DE CLASSIFICAÇÃO DE ALTO/BAIXO NO TEXTO DE EXPOSIÇÃO',       
}
