                    ...
                    if len(extra) != 0:
                        ...
                        for i in l:
                            if i in locex:
                                l2.update({i: locex[i]})
                        print(l2)
                    u = [item[1:] for item in pool3 if 'GEX' or 'HEX' or 'WEX' or 'XEX' or 'YEX' or 'ZEX' or 'KEX' or 'MEX' or 'NEX' or 'AEX' or 'DEX' in item]
                    ucont=len(u)
                    ucont2=2*ucont
                    agu = 2*len(pool3)
                    agu=agu-ucont2
