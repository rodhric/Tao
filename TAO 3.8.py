                ...
                try:
                    ...
                    if estação=='⚏ INVERNO' or estação=='⚍ PRIMAVERA':
                        if shu_h >18 or shu_h<6: # NOITE
                            if b2>26 and c4>1:
                                warn_pun.add('FAVORECIMENTO CLIMÁTICO A CANÍCULA')  
                        else: # DIA
                            if b2>30 and c4>1:
                                warn_pun.add('FAVORECIMENTO CLIMÁTICO A CANÍCULA')  
                    ...
                    if estação=='⚍ PRIMAVERA':
                        if shu_h >18 or shu_h<6: # NOITE
                            if b2>25 and c4<=1:
                                warn_pun.add('FAVORECIMENTO CLIMÁTICO A CALOR DE PRIMAVERA') 
                        else: # DIA
                            if b2>29 and c4<=1:
                                warn_pun.add('FAVORECIMENTO CLIMÁTICO A CALOR DE PRIMAVERA') 
                    ...
                    if estação=='⚌ VERÃO':
                        if shu_h >18 or shu_h<6: # NOITE
                            if umidade >60:
                                warn_pun.add('FAVORECIMENTO CLIMÁTICO A CALOR DE VERÃO') 
                        else: # DIA                    
                            if umidade >50:
                                warn_pun.add('FAVORECIMENTO CLIMÁTICO A CALOR DE VERÃO')                             
                    ...
                    if estação=='⚌ VERÃO':
                        if b2>27 and chuva==True:
                            warn_pun.add('FAVORECIMENTO CLIMÁTICO A CALOR DE UMIDADE')                           
                    if estação=='⚎ OUTONO':
                        if onlymonth==3:
                    ...
                    if estação=='⚎ OUTONO' and umidade<15:
                        warn_pun.add('FAVORECIMENTO CLIMÁTICO A SECURA DE OUTONO')                         
                    # TIPO C6 CALOR LATENTE DE VERÃO
                    if estação=='⚎ OUTONO':
                        if shu_h >18 or shu_h<6: # NOITE
                            if b2>23:
                                warn_pun.add('FAVORECIMENTO CLIMÁTICO A CALOR LATENTE DE VERÃO')
                        else: # DIA  
                            if b2>27:                  
                                warn_pun.add('FAVORECIMENTO CLIMÁTICO A CALOR LATENTE DE VERÃO')
                    ...
                    if estação=='⚏ INVERNO':
                        if shu_h >18 or shu_h<6: # NOITE
                            if b2>26:
                                warn_pun.add('FAVORECIMENTO CLIMÁTICO A CALOR DE INVERNO')
                        else: # DIA  
                            if b2>30:        
                                warn_pun.add('FAVORECIMENTO CLIMÁTICO A CALOR DE INVERNO')
                    ...
                    if estação=='⚎ OUTONO':
                        if int(b1)<70 and umidade<20:
                            warn_pun.add('FAVORECIMENTO CLIMÁTICO A CALOR DE SECURA')               
                except:
                    pass
                if len(warn_pun)!=0:
        ...
        if dorquery=='S':
            ...
            if 'X' not in h5 and len(h5)>1:
                ...
                if 'A' in h5:
                    ...
                    if toxic==True:
                        warn_pun.add('FAVORECIMENTO A CALOR TÓXICO')
                    if 'AE' in h5:
                        h8.add(h6+e)
                    if 'AF' in h5:
                        h8.add(h6+f)
...
# -------------------------------------- VERIFICAÇÃO DE DIAGNÓSTICO - PARTE 4
        ...
        print('\nHDA:')
        print(hda)
        print('\nDIAGNÓSTICOS CONFIRMADOS DE '+nome+':')        
