...
# -------------------------------------- VERIFICAÇÃO DE DIAGNÓSTICO - PARTE 4
        ...
        if 'C' in det_4:
            smt.add('DOR MUSCULAR POR PULSO DE CORAÇÃO EM RITMO SHU-RÁPIDO')
        if 'C' in det_3:
            smt.add('RISO INCOERENTE, FOBIA SOCIAL E RISCO DE HÉRNIAS POR PULSO DE CORAÇÃO EM RITMO CHI-LENTO')
        if 'C' in det_9:
            smt.add('SENSAÇÃO DE OBJETO EM GARGANTA POR PULSO DE CORAÇÃO EM RITMO CHANG-LONGO')
        if 'C' in det_15 or 'C' in det_14:
            smt.add('SÍNDROME DE DOR OBSTRUTIVA (BI) EM COSTAS POR PULSO DE CORAÇÃO EM RITMO XIAN-CORDA OU JIN-TENSO')
        if 'C' in det_12 or 'C' in det_10:
            smt.add('RISCO DE DIABETES, TENDÊNCIA A SOLUÇOS POR PULSO DE CORAÇÃO EM RITMO XI-FINO OU DUAN-CURTO')
        if 'C' in det_7:
            smt.add('TENDÊNCIA A SEDE POR PULSO DE CORAÇÃO EM RITMO HUA-DESLIZANTE') 
        if 'C' in det_27 or 'C' in det_28 or 'C' in det_22 or 'C' in det_25 or 'C' in det_26:
            smt.add('TENDÊNCIA A MUDEZ, CEFALÉIA E HEMORRAGIAS POR PULSO DE CORAÇÃO EM RITMO SAN-DISPERSO OU CU-PRECIPITADO OU JIE-NODOSO OU DAI-INTERMITENTE OU JI-ACELERADO') 
        if 'P' in det_15 or 'P' in det_14:
            smt.add('TENDÊNCIA A EPILEPSIA E ESQUIZOFRENIA, CANSAÇO EM COSTAS E LESÕES REPETIDAS EM NARINAS POR PULSO DE PULMÃO EM RITMO JIN-TENSO')
        if 'P' in det_3:
            smt.add('DOR ESCAPULAR E SUDORESE DIFUSA POR PULSO DE PULMÃO EM RITMO CHI-LENTO') 
        if 'P' in det_11:
            smt.add('DOR/INCHAÇO EM PERNAS/PÉ OU DOR EM COSTAS COM IRRITABILIDADE AO SOL POR PULSO DE PULMÃO EM RITMO HONG-TRANSBORDANTE') 
        if 'P' in det_12 or 'P' in det_10:
            smt.add('TENDÊNCIA A DIABETES OU DIARRÉIAS POR PULSO DE PULMÃO EM RITMO DUAN-CURTO')                                    
        if 'P' in det_7:
            smt.add('RESPIRAÇÃO RÁPIDA E REVERSÃO DE QI DE PULMÃO COM RISCOS DE HEMORRAGIAS POR PULSO DE PULMÃO EM RITMO HUA-DESLIZANTE') 
        if 'P' in det_27 or 'P' in det_28 or 'P' in det_22 or 'P' in det_25 or 'P' in det_26:
            smt.add('VÔMITOS COM SANGUE, ESCRÓFULA EM PESCOÇO OU AXILAS COM CÃIMBRAS POR PULSO DE PULMÃO EM RITMO SAN-DISPERSO OU CU-PRECIPITADO OU JIE-NODOSO OU DAI-INTERMITENTE OU JI-ACELERADO')
        if 'F' in det_14:
            smt.add('AGRESSIVIDADE E VOZ ALTA POR PULSO DE FÍGADO EM RITMO JIN-TENSO') 
        if 'F' in det_3:
            smt.add('VÔMITOS E DOR DISTENSIVA AO ALIMENTAR POR PULSO DE FÍGADO EM RITMO CHI-LENTO') 
        if 'F' in det_11:
            smt.add('CARBÚNCULO, VÔMITOS, EPISTAXE E DOR EM FLANCO DIREITO OU DOR GENITAL COM LESÃO FUNDA OU DOR EM RIM AO TOSSIR POR PULSO DE FÍGADO EM RITMO HONG-TRANSBORDANTE')
        if 'F' in det_9:
            smt.add('EXCESSO DE FOME E SEDE COM INCHAÇO MUSCULAR POR PULSO DE FÍGADO EM RITMO CHANG-LONGO') 
        if 'F' in det_7:
            smt.add(
        ...
        if 'BP' in det_3:
            smt.add('FRAQUEZA DE BRAÇOS E PERNAS COM TREMOR E FLACIDEZ POR PULSO DE BAÇO EM RITMO CHI-LENTO')
        if 'BP' in det_11:
            smt.add(
        ...
        if 'BP' in det_10 or 'BP' in det_12:
            smt.add('INCHAÇOS MUSCULARES RECORRENTES POR PULSO DE BAÇO EM RITMO DUAN-CURTO OU XI-FINO')
        if 'BP' in det_7:
            smt.add('INCHAÇO E QUEIMAÇÃO GENITAL COM DOR ABDOMINAL POR PULSO DE BAÇO EM RITMO HUA-DESLIZANTE')
        if 'BP' in det_27 or 'BP' in det_28 or 'BP' in det_22 or 'BP' in det_25 or 'BP' in det_26:
            smt.add('ALTERAÇÃO GINECOLÓGICA E LESÕES OCULTAS ULCERADAS INTESTINAIS POR PULSO DE BAÇO EM RITMO SAN-DISPERSO OU CU-PRECIPITADO OU JIE-NODOSO OU DAI-INTERMITENTE OU JI-ACELERADO')
        if 'R' in det_14:
            smt.add('OSSOS FRACOS, PÉ FRIO E DURO, TENDÊNCIA A DELÍRIOS, RETENÇÃO FECAL E URINÁRIA POR PULSO DE RIM EM RITMO JIN-TENSO') 
        if 'R' in det_3:
            smt.add('DOR INTENSA EM COLUNA COM REFLUXO AOS ALIMENTOS POR PULSO DE RIM EM RITMO CHI-LENTO') 
        if 'R' in det_11:
            smt.add('TENDÊNCIA A IMPOTÊNCIA E HÉRNIAS ABDOMINAIS POR PULSO DE RIM EM RITMOHONG-TRANSBORDANTE')
        ...
        if 'R' in det_27 or 'R' in det_28 or 'R' in det_22 or 'R' in det_25 or 'R' in det_26:
            smt.add('TENDÊNCIA A CARBÚNCULOS E HEMORRÓIDAS POR PULSO DE RIM EM RITMO SAN-DISPERSO OU CU-PRECIPITADO OU JIE-NODOSO OU DAI-INTERMITENTE OU JI-ACELERADO')
        ...
        if vector1[4]>m: # R
            if vector1[2]>m:
                ...
                smt.add('borborismos, fezes secas e paradas, tosse, dispnéia, disfonia, asma'.upper()+'Não-Geração: metal não gerando água'.upper())
...
def anam():
    ...
    while True:
        try:
            ...
            if qq1 == 'S':
                questionario.add('Recomendado ponto janela')
                break
            if qq1 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq2 == 'S':
                questionario.add('Recomendado ponto estrela')
                break
            if qq2 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq3 == 'S':
                questionario.add('Recomendado avaliar Su Si Miao')
                break
            if qq3 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq4 == 'S':
                questionario.add('Sugerido usar Mu Xu para Olhos')
                break
            if qq4 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq5 == 'S':
                questionario.add('Recomendado ponto mu para doença recente correlacionada')
                break
            if qq5 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq6 == 'S':
                questionario.add('Usar ponto poço para meridiano com paresia')
                break
            if qq6 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq7 == 'S':
                questionario.add('Usar ponto poço para meridiano com dor')
                break
            if qq7 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq8 == 'S':
                questionario.add('Avaliar usos de pontos rio')
                break
            if qq8 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq9 == 'S':
                questionario.add('Avaliar usos de pontos mar')
                break
            if qq9 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq10 == 1:
                questionario.add('Tonificar yuan de Coração')
                break
            if qq10 == 2:
                questionario.add('Tonificar yuan de Baço')
                break
            if qq10 == 3:
                questionario.add('Tonificar yuan de Pulmão')
                break
            if qq10 == 4:
                questionario.add('Tonificar yuan de Rim')
                break
            if qq10 == 5:
                questionario.add('Tonificar yuan de Fígado')
                break
            if qq10 == 9:
                break
        except:
    ...
    while True:
        try:
            ...
            if qq11 == 'S':
                questionario.add('Ver local de dor e analisar uso de Luo Mai')
                break
            if qq11 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq12 == 'S':
                questionario.add('Uso de ponto Xi para hemorragia')
                break
            if qq12 == 'N':
                break
        except:
    ...
    if qqhui == True:
        questionario.add('Recomendado uso de ponto Hui')
    while True:
        try:
            ...
            if qq17 == 4:
                ...
                if qqa == '+':
                    questionario.add('Recomendado tratamento tonificado de Po')
                    break
                if qqa == '-':
                    questionario.add('Recomendado tratamento sedado de Po')
                    break
                if qqa != '+' and qqa != '-':
            ...
            if qq17 == 1:
                ...
                if qqaa == 1:
                    questionario.add('Recomendado tratamento sedado de Hun')
                    break
                if qqaa == 2:
                    questionario.add('Recomendado tratamento tonificado de Hun')
                    break
            if qq17 == 2:
                questionario.add('Recomendado tratamento tonificado de Xiang')
                break
            if qq17 == 3:
                questionario.add('Recomendado tratamento tonificado de Yi')
                break
            if qq17 == 5:
                questionario.add('Recomendado tratamento tonificado de Zhi')
                break
        except:
            continue
    while True:
        try:
            if tipo_p[15] in pool:
                ...
                if qq18 == 'S':
                    questionario.add('Recomendado tratamento via Dai Mai')
                    break
                if qq18 == 'N':
                    break
            else:
    ...
    while True:
        try:
            ...
            continue
    if tipo_p[19] in pool:
        questionario.add('Avaliar uso de Chong Mai (VP)')
    if tipo_p[1] and tipo_p[9] in pool:
        questionario.add('Avaliar uso de Du Mai (VG)')
    while True:
        try:
            ...
            if qq22 == 'S':
                ...
                if qq23 == 1:
                    questionario.add('Excesso de Mar de Qi')
                    break
                if qq23 == 2:
                    questionario.add('Deficiência de Mar de Qi')
                    break
                if qq23 == 9:
                    break
        except:
    ...
    while True:
        try:
            ...
            if qq24 == 1:
                questionario.add('Excesso de Mar de Xue')
                break
            if qq24 == 2:
                questionario.add('Deficiência de Mar de Xue')
                break
            if qq24 == 9:
                break
        except:
    ...
    while True:
        try:
            ...
            if qq25 == 1:
                questionario.add('Excesso de Mar de Gu')
                break
            if qq25 == 2:
                questionario.add('Deficiência de Mar de Gu')
                break
            if qq25 == 9:
                break
        except:
    ...
    while True:
        try:
            ...
            if qq26 == 'S':
                questionario.add('Deficiência de Mar de Xiang')
                print()
                only()
            if qq26 == 'N':
                cls()
