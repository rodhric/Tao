                        ...
                        if sexo == 'M' or sexo == 'F':
                            ...
                            if idd>5 or idd<110:
                                ...
                                if sexo == 'F':
                                    ...
                                    if aco2 !='':
                                        aco3=input('Data de nascimento (DD/MM/AA): ')
                                        if len(aco3)==8:
                                            aco4=input('Telefone do acompanhante com DDD (xx)xxxx-xxxx: ')
                                            if len(aco4)==10:
                                                acompanhante=aco1+', '+aco2+', data de nascimento em '+aco3+', telefone: '+aco4
                                                break
                                            else:
                                                continue
                                        else:
                            ...
                            if idd > 5 or idd < 110:
                                ...
                                if sexo == 'F':
                                    ...
                                    if aco2 != '':
                                        ...
                                        if len(aco3) == 8:
                                            aco4 = input(
                                                'Telefone do acompanhante com DDD (xx)xxxx-xxxx: ')
                                            if len(aco4) == 10:
                                                acompanhante = aco1+', '+aco2+', data de nascimento em '+aco3+', telefone: '+aco4
                                                break
                                            else:
