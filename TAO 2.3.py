            ...
            if len(seta) < 1:
                ...
                if digprepre.isnumeric() == True:
                    ...
                    if 'FIM' in digpre:
                        ...
                        data=[str(nome),str(expodn)+', '+str(idd)+' anos',str(acompanhante.upper()),str(horadia),str(comfx),str(pureli),str(totpul),str(seta),str(acu2)]
                        ...
                        print('Tamanho dos arquivos salvos: ')
    ...
    while True:
        try:
            ...
            if os.path.exists('registro_acupuntura.csv') == True and os.path.exists('ailog.csv') == True:
                ...
                header=['NOME','DATA NASCIMENTO','ACOMPANHANTE','DATA DE EMISSÃO','COMPLEIÇÃO','LÍNGUA','PULSO','DIGNÓSTICOS','PRESCRIÇÃO ACUPUNTURA']
