...
- TAO 5.0.2: PREVIOUS VERSION DESYNCHRONIZED INPUTS AND ATTEMPTED ADJUSTMENTS WITHOUT DOWNGRADE (VERSION 5.0.1), SUCCESSFULLY PATCH INSERTION IN TEST AND PINNED ADDRESS MODULE ADDED
