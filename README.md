...
##### TAO 5.2.8: TABLE ADJUSTMENTS AND SCREEN CHANGES, ADJUSTMENT OF VALUES ARRANGEMENT WITH LONG TEXTS
##### TAO 5.2.9: HIGH/LOW/UNICODES SORT ERROR ADJUSTMENTS IN DISPLAY TEXT AND AUTOMATIC DATE DETECTION ADJUSTMENT FOR AGE IN 10-DIGITAL ENTRY
##### TAO 5.3.0:  REDUNDANT DATA EXPOSURE CORRECTION, DATABASE SIZE INFORMATION EXPOSURE ADJUSTMENT WITH ROUNDING AND BASED ON B/KB/MB/GB, CHANGING IN PRESCRIPTION AND SAVING PROGRESSION PANEL SWITCH
