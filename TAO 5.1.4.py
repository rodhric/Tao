    ...
    while True:
        try:
                    ...
                    if "FIM" in digpre:
                        ...
                        if homm == 'A':
                            ...
                            try:
                                ...
                                print('erro int(seta[int(0)]) - exemplo')
                            nq = int(export1)
                            try:
                                print(nq)
                            except:
                            ...
                            with open('registro_acupuntura.csv', 'a', encoding='UTF8', newline='',) as f:
                                ...
                                writer.writerow(data)
                            setal = list(seta)
                            for i in range(int(aix5)):
                                data = [int(setal[int(i)]), int(export1), int(export2), int(d1a), int(d1b), int(d1c), int(d2a), int(d2b), int(d2c), int(d3a), int(d3b), int(d3c), int(
                                    e1a), int(e1b), int(e1c), int(e2a), int(e2b), int(e2c), int(e3a), int(e3b), int(e3c), int(export3), int(export4), int(export5), int(aix1), int(aix2), int(aix3), int(aix4), int(aix5)]
            ...
            try:
                ...
                print('erro int(setal[int(0)]) - exemplo')
            nq = int(setal[1])
            try:
                print(nq)
            except:
                print('erro int(setal[int(1)]) - exemplo')
            nq = int(export1)
            try:
                print(nq)
            except:
...
atualizações = {
    ...
    'TAO 5.1.5': 'TENTATIVA DE CORREÇÃO DE LOOP DE DIAGN´SOTICOS',
}
