        ...
        try:
            ...
            if rede is True:
                ...
                if shu_h<=19 and shu_h>=16:
                    warn_pun.add('⚠ VERIFICAR NEBULOSIDADE, EM BREVE, POSSÍVEL LUA OCULTA')
                if len(warn_pun)!=0:
                    for i in sorted(list(warn_pun)):
                        print(i)                      
