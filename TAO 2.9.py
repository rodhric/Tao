...
def home():
    while True:
        cls()
        time.sleep(2)
        print('\n\n\n\n\n\n\n\n\n\n\n\n\nTAO COPYRIGHT 2023 '+ver+' - PLATAFORMA OPERACIONAL PARA MEDICINA CHINESA')
        print('TCM IN DFF-PERCEPTRONS NEURAL NETWORK AI FOR BACK-END PYTHON VER. ' +platform.python_version())
        print('DESENVOLVIDO POR RODRIGO DIAS')
        time.sleep(5)
        cls()
        ...
        if os.path.exists('registro_acupuntura.csv') == True and os.path.exists('ailog.csv') == True and os.path.exists('registro_acupuntura.csv') == True:
            ...
            if os.path.exists('prontuario.csv') == False:
                ...
                a += 1
            print('SERVIDORES CONECTADOS: '+str(a))
                    ...
                    try:
                        ...
                        if os.path.exists('prontuario.csv') == True and pacienteantigo == True:
                            ...
                            if df.loc[df['CPF'].isin(["'"+str(cpf)+"'"])].empty:
                                print('Ainda não tem endereço cadastrado ao paciente...')
                            else:
                        ...
                        if len(cep) == 8 and cep.isnumeric() == True:
                            ...
                            addr = str(input('\nDigite local atual do atendimento: ')).upper()
                        if sexo == 'M':
                            global acompanhante
