...
def home():
    while True:
        try:
            def conexão ():
                cmd = os.system('ping 1.1.1.1 -w 3 -n 1 > clear')
                if cmd == 0:
                    return True
                else:
                    return False    
            ...
            if rede is True:
                try:
                    ...
                    if shu_h>18 and faselunar=='☷ LUA NOVA': 
                        warn_pun.add('🛈 NÃO SEDAR ESTA NOITE')                                               
                    if shu_h>18 and faselunar=='☰ LUA CHEIA':
                        warn_pun.add('🛈 NÃO TONIFICAR ESTA NOITE')
                    ...
                    b2 = a1['temperature']
                    if int(b2)<20:
                        warn_pun.add('⦸ PROSCRITO: TEMPERATURA MUITO BAIXA')
                    if int(b2)>31:
                    ...
                    if int(b1)>90:
                        if shu_h<18 and shu_h>16:
                            ...
                            if int(b3)!=26 and int(b3)!=27 and int(b3)!=28 and int(b3)!=29 and int(b3)!=1 and int(b3)!=2 and int(b3)!=3 and int(b3)!=4:
                                warn_pun.add('⦸ PROSCRITO: LUA OCULTA')
                    if shu_h>16:
                        if shu_h<18:
                            if int(b3)!=26 and int(b3)!=27 and int(b3)!=28 and int(b3)!=29 and int(b3)!=1 and int(b3)!=2 and int(b3)!=3 and int(b3)!=4:
                                warn_pun.add('⚠ EM BREVE POSSÍVEL LUA OCULTA')                                          
                    ...
                    c1=f'👁  {b1}% '
                    c2 = f'🌡 {b2}°C '
                    def traduzir(x): return '🛈 TEMPO INDISPONÍVEL' if x == 1 else  '☀ CÉU ENSOLARADO' if x == 2 else  '☀ CÉU PREDOMINANTEMENTE ENSOLARADO' if x == 3 else  '☀ CÉU PARCIALMENTE ENSOLARADO' if x == 4 else  '☁  CÉU PREDOMINANTEMENTE NUBLADO' if x == 5 else  '☁  CÉU NUBLADO' if x == 6 else  '☁  CÉU TOTALMENTE NUBLADO' if x == 7 else  '☁  CÉU NUBLADO COM NÚVENS BAIXAS' if x == 8 else  '☁  TEMPO COM NEBLINA' if x == 9 else  '☂ CHUVA LEVE' if x == 10 else  '☂ CHUVA' if x == 11 else  '⛈ CHUVAS ISOLADAS' if x == 12 else  '☂ CHUVAS ENSOLARADAS' if x == 13 else  '☂ TEMPESTADE' if x == 14 else  '☂ TEMPESTADES LOCAIS' if x == 15 else  '☂ CHUVA DE GRANIZO' if x == 16 else  '❆ GRANIZO' if x == 17 else  '❆ POSSIBILIDADE DE GRANIZO' if x == 18 else  '❆ NEVE' if x == 19 else  '❆ NEVASCA' if x == 20 else  '❆ POSSÍVEL NEVASCA' if x == 21 else  '❆ NEVASCA' if x == 22 else  '❆ CHUVA SÓLIDA' if x == 23 else  '☂ POSSÍVEL CHUVA TORRENCIAL' if x == 24 else  '❆ CHUVA DE GRANIZO' if x == 25 else  '★ NOITE CLARA' if x == 26 else  '★ NOITE PREDOMINANTEMENTE CLARA' if x == 27 else  '★ NOITE PARCIALMENTE CLARA' if x == 28 else  '☁  NOITE PARCIALMENTE NUBLADA' if x == 29 else  '☁  NOITE NUBLADA' if x == 30 else  '☁  NOITE NUBLADA COM NÚVENS BAIXAS' if x == 31 else  '☂ NOITE CHUVOSA' if x == 32 else  '☂ NOITE COM TEMPESTADES LOCAIS' if x == 33 else  '☁  NOITE DE NEBLINA' if x == 34 else  '❆ NOITE DE NEVE' if x == 35 else  '☂ NOITE DE CHUVA TORRENCIAL' if x == 36 else None
                    c3=traduzir(int(b3))
                    pre_c4=a1['wind']
                    c4=pre_c4['speed']
                    # VENTO c4                     
                    ...
                    b = ger_hor_atu.strftime("%m")
                    c = ger_hor_atu.strftime("%d")
                    city = LocationInfo("Brasilia", "Brazil", 'America/Sao_Paulo', -15.8031, -47.8969)
                    s = sun(city.observer, date=datetime.date(int(a), int(b), int(c)))
                    ss1=str(s["sunset"])
                    ss2=ss1.split(":")
                    ss3=ss2[1:2]
                    ss3=limpar(ss3)
                    ...
                    if estação=='⚏ INVERNO' or estação=='⚍ PRIMAVERA':
                        if shu_h >18 or shu_h<6: # NOITE
                            if b2>26 and c4>1:
                                warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CANÍCULA')  
                        else: # DIA
                            if b2>30 and c4>1:
                                warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CANÍCULA')  
                    ...
                    if estação=='⚍ PRIMAVERA':
                        if shu_h >18 or shu_h<6: # NOITE
                            if b2>25 and c4<=1:
                                warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR DE PRIMAVERA') 
                        else: # DIA
                            if b2>29 and c4<=1:
                                warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR DE PRIMAVERA') 
                    ...
                    if estação=='⚌ VERÃO':
                        if shu_h >18 or shu_h<6: # NOITE
                            if umidade >60:
                                warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR DE VERÃO') 
                        else: # DIA                    
                            if umidade >50:
                                warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR DE VERÃO')                             
                    # TIPO C4 CALOR DE UMIDADE
                    def chuva(x): return True if x == 10 else True if x == 11 else True if x == 13 else True if x == 14 else True if x == 15 else True if x == 19 else True if x == 20 else True if x == 22 else True if x == 23 else True if x == 32 else True if x == 33 else False
                    chuva=chuva(int(b3))
                    if estação=='⚌ VERÃO':
                        if b2>27 and chuva==True:
                            warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR DE UMIDADE')                           
                    if estação=='⚎ OUTONO':
                        if onlymonth==3:
                    ...
                    if estação=='⚎ OUTONO' and umidade<15:
                        warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: SECURA DE OUTONO')                         
                    # TIPO C6 CALOR LATENTE DE VERÃO
                    if estação=='⚎ OUTONO':
                        if shu_h >18 or shu_h<6: # NOITE
                            if b2>23:
                                warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR LATENTE DE VERÃO')
                        else: # DIA  
                            if b2>27:                  
                                warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR LATENTE DE VERÃO')
                    ...
                    if estação=='⚏ INVERNO':
                        if shu_h >18 or shu_h<6: # NOITE
                            if b2>26:
                                warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR DE INVERNO')
                        else: # DIA  
                            if b2>30:        
                                warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR DE INVERNO')
                    ...
                    if estação=='⚎ OUTONO':
                        if int(b1)<70 and umidade<20:
                            warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR DE SECURA')               
                except:
                    pass
                if len(warn_pun)!=0:
                    for i in sorted(list(warn_pun)):
                        print(i)                
                print('HORA DO SHU ATUAL: ' +shu_agora+'\nPRÓXIMA HORA EM SHU: '+shu_proximo)
            else:
                toxic=False
                shu('')
            if os.path.exists('registro_acupuntura.csv') == True and os.path.exists('ailog.csv') == True and os.path.exists('registro_acupuntura.csv') == True:
                print('\n✔ SERVIDORES: TODOS CONECTADOS')
            else:
                a=0
                if os.path.exists('registro_acupuntura.csv') == False :
                    print('\n✘ BANCO DE DADOS: INATIVA')
                    a+=1
                if os.path.exists('ailog.csv') == False:
                    print('✘ BASE DE ANÁLISE: INATIVA')
                    a+=1                
                if os.path.exists('prontuario.csv') == False:
                    print('✘ BANCO DE PRONTUÁRIOS: INATIVA')
                    a += 1
                print('✔ SERVIDORES CONECTADOS: '+str(int(3)-int(a)))
            if rede is True:
            ...
            print('[H] REABRIR ÚLTIMA PRESCRIÇÃO')            
            print('[Z] INSTALAR BANCO DE DADOS')            
            if rede is False:         
                print('\n⚠  ATENÇÃO: SEM ACESSO A INTERNET')   
                print('🛈  APERTE ENTER PARA RECONECTAR REDE DE INTERNET\n')            
            ...
            if homm == 'A' or homm=='D' or homm=='H':
                ...
                if str(cpf)==str(tescpf):
                    print('CPF é válido em estado(s): '+origem(oricpf)+'\n\n')
                    ...
                    while True:
                        try:
                            ...
                            if pacienteantigo==True:
                                ...
                                i=lambda x: print('Feminino') if x=='F' else print('Masculino') if x=='M' else None
                                i(sexo)
                                ddtot=str(d2['DATA NASCIMENTO'].values[0])
                                print('Data de Nascimento: '+ddtot)                    
                                global pre_especcodcompa_dn        
                                pre_especcodcompa_dn=str(d2['SUF'].values[0])
                            else:
                            ...
                            expodn = dtot[0]+dtot[1]+'/'+dtot[2] + \
                                dtot[3]+'/' + dtot[4]+dtot[5]
                            idi = dtot[4]+dtot[5]
                            idi = int(idi, 10)
                            ...
                            if pacienteantigo == False:
                                ...
                                if len(cep) == 8 and cep.isnumeric() == True:
                                    try:
                                        ...
                                        c5 = dict_end['uf']
                                        print(str(c1)+ ' >>> COMPLEMENTO <<<<, '+str(c2)+', CEP: ' + str(c3)+' - '+str(c4)+'/'+str(c5))
                                        cx = str(input('Complemente (número, lote, apt.): ').upper())
                                        end = str(c1)+' '+cx+', '+str(c2)+', CEP: ' + str(c3)+' - '+str(c4)+'/'+str(c5)
                                        addr=str(end)
                                        print(addr)
                                    except:
                                        if rede is True:
                                            ...
                                            addr = str(input('\nServidor indisponível. Digite endereço do local atual do atendimento: ')).upper()
                                else:
                                    print('\nDigite o CEP corretamente!\n\n')
                                    time.sleep(2)
                                    continue                                                                   
                            elif os.path.exists('prontuario.csv') == True:
                                ...
                                if df.loc[df['CPF'].isin(["'"+str(cpf)+"'"])].empty:
                                    ...
                                    total = int(len(d3['LOCAL DE ATENDIMENTO'].values))
                                    dbend = str(d3['LOCAL DE ATENDIMENTO'].values[total-1])
                                    print('\n')
                                    print(dbend.upper())    
                                    pulo=input('Manter local de atendimento? (S/N) ').upper()    
                                    if pulo!='S':                        
                                        cep = input('\nDigite o CEP: ')
                                        if len(cep) == 8 and cep.isnumeric() == True:
                                            try:
                                        ...
                                        addr=str(d3['LOCAL DE ATENDIMENTO'].values[total-1])
                            achom=input('\nDeseja adicionar acompanhante da sessão? (S/N) ').upper()
                            if sexo == 'M' and achom=='N':
                                global acompanhante
                                acompanhante = 'IGNORADO'
                                print('✔  SUCESSO!')
                                time.sleep(2)
                                if homm == 'A':
                                    ben()
                                if homm == 'D':
                                    only()                                                              
                            if sexo == 'F' or achom=='S':
                                print('\n\nREGISTRO DE ACOMPANHANTE EM INFORMAÇÕES A SEGUIR:')
                                aco1 = input('Nome completo de acompanhante: ').upper()
                                aco2 = input('Vinculo com paciente (mãe, marido, amiga): ').upper()
                                if aco2 != '': 
                                    if aco1!='':                                
                                        aco3 = str(input('Data de Nascimento: '))
                                        if len(aco3) == 6 and aco3.isnumeric() == True:
                                            aco3.split()
                                            pra_especcodcompa_dn = aco3[4]+aco3[5]
                                            propro_especcodcompa_dn = int(pra_especcodcompa_dn, 10)
                                            pre_especcodcompa_dn_aco= str(input('Digite A para 1900 e B para 2000: ').upper())
                                            if pre_especcodcompa_dn_aco== 'A':
                                                especcodcompa_dn = 1900+propro_especcodcompa_dn
                                                if ano_comparador < especcodcompa_dn:
                                                    print('ERRO DE DATAS!')
                                                    continue
                                            if pre_especcodcompa_dn_aco== 'B':
                                                especcodcompa_dn = 2000+propro_especcodcompa_dn
                                            if ano_comparador < especcodcompa_dn:
                                                print('ERRO DE DATAS!')
                                                continue
                                        dtot = str(aco3)
                                        if len(aco3) == 8 and aco3.isnumeric() == False:
                                            subdtot = aco3.split('/')
                                            pre_especcodcompa_dn_aco= str(
                                                input('Digite A para 1900 e B para 2000: '))
                                            pre_especcodcompa_dn.upper()
                                            if pre_especcodcompa_dn_aco== 'A':
                                                pro_especcodcompa_dn = 1900
                                            ...
                                            if len(parte1) == 2:
                                                parte1_aco3 = parte1
                                            if len(parte1) == 1:
                                                parte1_aco3 = '0'+parte1
                                            str(parte2)
                                            if len(parte2) == 2:
                                                parte2_aco3 = parte2
                                            if len(parte2) == 1:
                                                parte2_aco3 = '0'+parte2
                                            str(parte3)
                                            if len(parte3) == 2:
                                                parte3_aco3 = parte3
                                            if len(parte3) == 1:
                                                parte3_aco3 = '0'+parte3
                                            dtot = parte1_aco3+parte2_aco3+parte3_aco3
                                        if len(aco3) == 8 and aco3.isnumeric() == True:
                                            aco3.split()
                                            pre_especcodcompa_dn_aco= aco3[4] + \
                                                aco3[5]+aco3[6]+aco3[7]
                                            especcodcompa_dn = int(
                                                pre_especcodcompa_dn, 10)
                                            if ano_comparador < especcodcompa_dn:
                                                print('ERRO DE DATAS!')
                                            parte1 = aco3[0]+aco3[1]
                                            str(parte1)
                                            if len(parte1) == 2:
                                                parte1_aco3 = parte1
                                            if len(parte1) == 1:
                                                parte1_aco3 = '0'+parte1
                                            parte2 = aco3[2]+aco3[3]
                                            str(parte2)
                                            if len(parte2) == 2:
                                                parte2_aco3 = parte2
                                            if len(parte2) == 1:
                                                parte2_aco3 = '0'+parte2
                                            parte3 = aco3[6]+aco3[7]
                                            str(parte3)
                                            if len(parte3) == 2:
                                                parte3_aco3 = parte3
                                            if len(parte3) == 1:
                                                parte3_aco3 = '0'+parte3
                                            dtot = str(parte1_aco3) + \
                                                str(parte2_aco3)+str(parte3_aco3)
                                        if len(aco3) == 10 and aco3.isnumeric() == False:
                                            sudd = aco3.split('/')
                                            pro_especcodcompa_dn = sudd[2]
                                            especcodcompa_dn = int(pro_especcodcompa_dn, 10)
                                            if ano_comparador < especcodcompa_dn:
                                            ...
                                            parte3_aco = sudd[2]
                                            parte3_aco.split()
                                            pro3 = parte3_aco[2]+parte3_aco[3]
                                            dtot = parte1_aco+parte2_aco+pro3
                                        dtot.split()
                                        dn1 = dtot[0]
                                        str(dn1)
                                        dn2 = dtot[1]
                                        ...
                                        dn4 = dtot[5]
                                        str(dn4)
                                        aco3 = dtot[0]+dtot[1]+'/'+dtot[2]+dtot[3]+'/'+dtot[4]+dtot[5]
                                        idi = dtot[4]+dtot[5]
                                        idi = int(idi, 10)
                                        if idi > anoge:  
                                            anonew = anoge+100
                                        ...
                                        if int(idade) > 0:
                                            aco4 = str(input('Telefone do(a) acompanhante: '))
                                            if len(aco4) > 7:
                                                acompanhante = aco1+', '+aco2+', data de nascimento em '+aco3+', idade: '+idade+' anos, contato: '+str(aco4)
                                                print('ACOMPANHADA DURANTE A SESÃO DE: '+str(acompanhante).upper())
                                                time.sleep(2)
                                                print('\n\n✔  SUCESSO!')
                                                time.sleep(2)
                                                if homm == 'A':
                ...
                if os.path.exists('registro_acupuntura.csv') == True:
                    ...
                    print("CASO DESEJA REINICIAR BANCO DE DADOS LOCALMENTE, ACESSE OPÇÃO 'Z' EM MENU")
                    time.sleep(9)
                    continue
            elif homm=='Z':
                gerar_arquivos()
...
def ler():
    ...
    if df.loc[df['CPF'].isin(["'"+str(cpf)+"'"])].empty:
        ...
        d = str(d3['DIAGNÓSTICOS'].values[total-1])
        print('\n')
        print(f'♻  LEITURA DE PRONTUÁRIO {b} - {c}')
        print(d+'\n')
        if len(a)==0:
            ...
            for i in range(t):
                l.add(m[i])          
            p = [item for item in l if 'P' in item[0] and not 'C' in item[1]]
            if len(p) != 0:
                print('\n☷☰ TAIYIN DA MÃO - FEI (PULMÃO):')
                print(limpar(sorted(p)))
            ig = [item for item in l if 'I' in item[0] and 'G' in item[1]]
            if len(ig) != 0:
                print('\n☲☰ YANGMING DA MÃO - DACHANG (INTESTINO GROSSO):')
                print(limpar(sorted(ig)))
            bp = [item for item in l if 'B' in item[0] and 'P' in item[1]]
            if len(bp) != 0:
                print('\n☷☷ TAIYIN DO PÉ - PI (BAÇO):')
                print(limpar(sorted(bp)))
            e = [item for item in l if 'E' in item[0] and not 'X' in item[1]]
            if len(e) != 0:
                print('\n☲☷ YANGMING DO PÉ - WEI (ESTÔMAGO):')
                print(limpar(sorted(e)))
            pc = [item for item in l if 'PC' in item[0:]]
            if len(pc) != 0:
                print('\n☴☰ JUEYIN DA MÃO - XINBAO (PERICÁRDIO):')
                print(limpar(sorted(pc)))
            ta = [item for item in l if 'T' in item[0] and 'A' in item[1]]
            if len(ta) != 0:
                print('\n☳☰ SHAOYIN DA MÃO - SANJIAO (TRIPLO AQUECEDOR):')
                print(limpar(sorted(ta)))
            c = [item for item in l if 'C' in item[0]]
            if len(c) != 0:
                print('\n☵☰ SHAOYIN DA MÃO - XIN (CORAÇÃO):')
                print(limpar(sorted(c)))
            id = [item for item in l if 'I' in item[0] and 'D' in item[1]]
            if len(id) != 0:
                print('\n☰☰ TAIYANG DA MÃO - XIAOXANG (INTESTINO DELGADO):')
                print(limpar(sorted(id)))
            f = [item for item in l if 'F' in item[0]]
            if len(f) != 0:
                print('\n☴☷ JUEYIN DO PÉ - GAN (FÍGADO):')
                print(limpar(sorted(f)))
            vb = [item for item in l if 'V' in item[0] and 'B' in item[1]]
            if len(vb) != 0:
                print('\n☳☷ SHAOYANG DO PÉ - DAN (VESÍCULA BILIAR):')
                print(limpar(sorted(vb)))
            r = [item for item in l if 'R' in item[0:]]
            if len(r) != 0:
                print('\n☵☷ SHAOYIN DO PÉ - SHEN (RIM):')
                print(limpar(sorted(r)))
            b = [item for item in l if 'B' in item[0] and not 'P' in item[1]]
            if len(b) != 0:
                print('\n☰☷ TAIYANG DO PÉ - PANGGUAN (BEXIGA):')
                print(limpar(sorted(b)))
            vc = [item for item in l if 'V' in item[0] and 'C' in item[1]]
            if len(vc) != 0:
                print('\n☷ REN MAI (VASOCONCEPÇÃO):')
                print(limpar(sorted(vc)))
            vg = [item for item in l if 'V' in item[0] and 'G' in item[1]]
            if len(vg) != 0:
                print('\n☰ DU MAI (VASOGOVERNADOR):')
                print(limpar(sorted(vg)))
            extra = [item for item in l if 'E' in item[0] and 'X' in item[1]]
            if len(extra) != 0:
                print('\n🛈 PONTOS EXTRAMERIDIANOS:')
                l3=[i[0:] for i in extra]
                l2={}
                for i in l3:
                    if i in locex:
                        l2.update({i: locex[i]})
                for k,v in sorted(l2.items(), key=lambda x: x[2:], reverse=True):
                    print(k,'- ',v)
            x=input('')    
            zerar()  
def ben():
    while True:
        ...
        print()
        print('HISTÓRIA DA DOENÇA ATUAL \n\n1. tratamentos para doenças crônicas\n2. medicamentos em uso crônicos\n3. dores ou sintomas exóticos\n4. objetivo de tratamento na acupuntura\n5. diagnósticos de medicina oriental previamente\n\n')
        global hda
        hda = input('▶ ').upper()

        cls()
        if len(hda) > 311 or pacienteantigo==False:
            cls()
            print('\n\n\n\n\n\nPACIENTE NOVO OU MUDANÇA DO QUADRO CLÍNICO!\n\nAUTOMATICAMENTE REDIRECIONADO PARA QUESTIONÁRIO DE PROTOCOLOS APÓS EXAME FÍSICO...')
            time.sleep(9)
            cls()
        if len(hda)==0:
            hda='HDA EM BRANCO'
        termoquery = input('\n\nOCORREM SENSAÇÕES DE CALOR, FRIO OU SUOR NAS MÃOS OU PÉS (OU LOCALIZADOS) OU RESSEMCAMENTO DE PELE OU SUOR OU MESMO INCHAÇOS? (S/N) ').upper()
        global h3
        h3 = set()
        if termoquery == 'S':
        ...
        if dorquery=='S':
            ...
            if 'X' not in h5 and len(h5)>1:
                ...
                if 'D' in h5:
                    h6 = 'CALOR DE '
                    if toxic==True:
                        warn_pun.add('🅵 FAVORECIMENTO CLIMÁTICO: CALOR TÓXICO')                    
                    if 'DE' in h5:
                        h8.add(h6+e)
                    if 'DF' in h5:
                        h8.add(h6+f)
                ...
                def to1(x):
                    ...
                    if x=='BN' or x=='CN' :
                        return h8.add('DEFICIÊNCIA EM JING JIN DE INTESTINO DELGADO')
                    if x=='BP' or x=='CP' :
        ...
        while True:
            try:
                ...
                if comf == 5:
                    ...
                    if int(perfil[4]) > 2:
                        ...
                        print('\nRESULTADO:\nXIN '+c+'\nPI '+bp +
                            '\nFEI '+p+'\nSHEN '+r+'\nGAN '+f+'\n\n')                    
                        comf2 = int(
                            input('MAIOR PONTUAÇÃO (1-XIN (C), 2-PI (BP), 3-FEI (P), 4-SHEN (R), 5-GAN (F)\n\n▶ '))
                        if comf2 == 1:
                            comfx = 'Compleição de Coração'
                            break
                        if comf2 == 2:
                ...
                continue
        print(f'ANÁLISE DO EXAME DE COMPLEIÇÃO OU EIXO PRINCIPAL DE TRATAMENTO: \n{comfx.upper()}\n')
        while True:
            try:
        ...
        while True:
            try:
                ...
                if er3 == 'S':
                    ...
                    continue
                er4 = input('RENYING (JUGULAR) MUITO INTERMITENTE? (S/N) ').upper()
                if er4 == 'S':
                ...
                if er5 == 'S':
                    ...
                    continue
                er6 = input('RENYING (JUGULAR) MUITO FRACO? (S/N) ').upper()
                if er6 == 'S':
        ...
        if estação == '⚍ PRIMAVERA':
            warn_pun.add('Picar colaterais de canal e, se gravidade, atingir profundamente entre músculos - estação de primavera'.upper())
            ...
            warn_pun.add('Picar pontos shus de doenças yin ou pontos he de doenças yang, esfregar pele antes de aplicar e aplicar superficialmente - estação de outono'.upper())
        elif estação == '⚏ INVERNO':
            warn_pun.add('Picar canas afetados usar pontos poço e xing, picar profundamente em todas punturas e permanecer tempo longo de agulha - estação de inverno'.upper())
        if shu_agora == shu_proximo:
            warn_pun.add(f'HORÁRIO PROPÍCIO PARA SEDAR {shu_agora}')
        elif shu_agora != shu_proximo:
            warn_pun.add(f'HORÁRIO PROPÍCIO PARA TONIFICAR {shu_agora}')
        # -------------------------------------- PULSOLOGIA - PARTE 1
        cls()
        while True:
            try:
...
# -------------------------------------- LÍNGUA - PARTE 2
        ...
        print('\n\n\n\nANÁLISE DE LÍNGUA\n')
        print('• FORMA')
        print('(A) Longa (alta), (B) Curta (baixa), (C) Fina (magra), (D) Grossa (gorda)')
        print('Língua normal não deve ser inserida')
        print('• MOVIMENTO')
        print('(E) Duro (demora para levantar), (F) Flácido, (G) Trêmulo, (H) Desviado (pára em lugar errado)')
        print('• RACHADURA')
        print('(I) Linha média, (J) Periférico, (K) Afta, (L) Marca de dente, (M) Petéquias')
        print('• SABURRA')
        print('SE COR NÃO TRANSPARENTE -- (N) Saburra Branca, (O) Saburra Amarela/Laranja, (P) Saburra Cinza (um branco mais sujo)')
        print('SE FALTA -- (Q) Hemilíngua, (R) Meio, (S) Periférico, (T) Ausência Total de saburra')
        ...
        while True:
            try:
                lin = input('Insira parâmetros alterados (e.g. AUQ...)\n⨄ ⨠ ').upper()
        ...
        if a == 0 and d1a == 3 and a == 0:
            ...
            if 'U' and 'O' in lin and a == 0:
                if 'Z' in lin:
                    ...
                    while True:
                        try:
                            quente2 = input('Calor noite-tarde-dia (A) ou calor mais no final da Tarde somente (B): ').upper()                            
                            if quente2 == 'A':
                                dxconf.add(dx[199])
...
# -------------------------------------- VERIFICAÇÃO DE DIAGNÓSTICO - PARTE 4
        ...
        if tipo_p[7] in pool and sexo=='F':
            pool.add('HUA - DESLIZANTE (ESCORREGA NOS DEDOS, MÓVEL) DETERMINANDO OU FLEUMA OU UMIDADE OU GRAVIDEZ')
        if tipo_p[8] in pool:
        ...
        if tipo_p[12] in pool:
            pool.add('XI - FINO (MAIS FINO QUE O NORMAL) DETERMINA ANEMIA OU DEFICIÊNCIA DE XUE OU UMIDADE COM DEFICIÊNCIA GRAVE DE QI')
        if tipo_p[13] in pool:
        ...
        if tipo_p[23] in pool:
            pool.add('FUA - ESCORREGADIO (PROFUNDO E ADERIDO AO OSSO, SEM MOBILIDADE) DETERMINA DEFICIÊNCIA GRAVE DE YANG')
        if tipo_p[24] in pool:
        ...
        if tipo_p[26] in pool:
            pool.add('JIE - NODOSO (LENTO E INTERROMPIDO EM INTERVALOS REGULARES, BRADIARRITMIAS) DETERMINA FRIO VAZIO EM CORAÇÃO')
        if tipo_p[27] in pool:
        ...
        if tipo_p[28] in pool:
            pool.add('JI - ACELERADO (TAQUICARDIA COM GRANDE FORÇA) OU DA - GRANDE (TAQUICARDIA COM GRANDE FORÇA):  DETERMINA EXCESSO DE YANG COM FOGO EXAURINDO O YIN')
            ...
            try:
                ...
                if tipo_p[1] in pool:
                    ...
                    if tipo_p[13] in pool or tipo_p[14] in pool:
                        ...
                        ne1=input('Calor contínuo com intolerância a frio e dores em pescoço/cervical ou cabeça? (S/N) ').upper()
                        if ne1=='S':
                            ne2=input('O que incomoda mais? O vento(A), o frio(B) ou a sede(C)? ').upper()                        
                            if ne2=='A':
                                dxconff.add(str(dx[266]+' '+dx[202]).capitalize())
                                break
                            elif ne2=='B':
                                ...
                                ne3=input('Soa muito(A) ou pouco(B)? ').upper()                        
                                if ne3=='A':
                                    dxconff.add(str(dx[267]+' '+dx[202]).capitalize())
                                    break
                                if ne3=='B':
                                    dxconff.add(str(dx[268]+' '+dx[202]).capitalize())   
                                    break
                                else:
                                    continue
                            else:
        ...
        while True:
            try:                                         
                ...
                if tipo_p[14] in pool:                
                    a+=1
                if a>=2:
                    ne4=input('Sensação de corpo quente com aversão a calor e suores excessivos diários? (S/N) ').upper()
                    if ne4=='S':
                        ne5=input('Come bem e sempre tem fome nas refeições? (S/N) ').upper()
                        if ne5=='S':
                            dxconff.add(str(dx[266]+' '+dx[203]).capitalize())
                            break
                        elif ne5=='N':
                            dxconff.add(str(dx[265]+' '+dx[203]).capitalize())
                            break
                        else:
                            continue
                    elif ne4=='N':
        ...
        while True:
            try:          
                if tipo_p[2] in pool or tipo_p[14] in pool:
                    ne6=input('Ocorre alteração de paladar com gosto amargo? (S/N) ').upper()
                    ne7=input('No último mês ocorreu olhar fixo e parado sem pensar em nada involuntariamente (crise de ausência)? (S/N) ').upper()
                    if ne6=='S' or ne7=='S':
                        ne8=input('Sente continuamente pressão localizada em peito ou costela como se um músculo tivesse travado? (S/N) ').upper()
                        if ne8=='S':
                            dxconff.add(str(dx[266]+' '+dx[204]).capitalize())
                            break
                        elif tipo_p[15] in pool or tipo_p[12] in pool:
                            dxconff.add(str(dx[264]+' '+dx[204]).capitalize())
                            break
                        elif ne8=='N':
                            ne9=input('De repente, anima em falar demais com pessoas percebendo eventualmente (mensagens de voz longas)? (S/N) ').upper()
                            if ne9=='S':
                                dxconff.add(str(dx[264]+' '+dx[204]).capitalize())
                                break
                            elif ne9=='N':
        ...
        while True:
            try:                          
                ne10=input('Dor abdominal com diarréias recorrentres e únicas e tendência de beber pouca sede ao longo do dia, de modo geral? (S/N) ').upper()
                ...
                if ne10=='S':
                    a+=1
                if a>=2:
                    ne11=input('Irritação diária com diarréias que duram pelo menos 1 semana porém sumindo sozinha por semanas e reaparecendo do mesmo jeito? (S/N) ').upper()
                    if ne11=='S':
                        dxconff.add(str(dx[265]+' '+dx[205]).capitalize())
                        break
                    elif ne11=='N':
                        ne12=input('Dor em braços ou pernas, como se estivessem cansadas (sendo muito frequente o sintoma)? (S/N) ').upper()
                        if ne12=='S':
                            dxconff.add(str(dx[266]+' '+dx[205]).capitalize())
                            break
                        elif ne12=='N':
                            break
                        else:
        ...
        while True:
            try:                          
                ...
                if ne10=='S':
                    a+=1
                if a>=2:
                    ne13=input('Excesso de sono diariamente com tendência de ficar exausto? (S/N) ').upper()
                    ne14=input('Raiva e descontrole sem motivo aparente e subitamente, em momentos de calma, sendo em outros momentos, presente uma vontade de vomitar que não é bem náusea nem dor? (S/N) ').upper()
                    if ne13=='S' or ne14=='S':
                        dxconff.add(str('hang Han Lun/ '+dx[206]).capitalize()) 
                        break
        ...
        while True:
            try:
                ...
                #if ne15=='S':
                ne15=input('Deseja uma comida, ao ter a comida perde-se total apetite (dor/saciedade/incômodo/nojo)? (S/N) ').upper()
                if ne15=='S':
                    ne17=input('Em dias quentes quando se está atarefado(a) e na correria suando, ocorre diarréia súbida muito forte que some após episódio? (S/N) ').upper()
                    if ne17=='S':
                    ...
                    ne16=input('Existe sensação eventual de algo quente subindo pelo tórax? (S/N) ').upper()
                    if ne16=='S':
                        ne17=input('Em dias quentes quando se está atarefado(a) e na correria suando, ocorre diarréia súbida muito forte que some após episódio? (S/N) ').upper()
                        if ne17=='S':
                            dxconff.add(str(dx[265]+' '+dx[207]).capitalize())                              
        ...
        while True:
            try:                                          
                ...
                if 'saburra branca'.upper() in pureli:                
                    a+=1
                if a>=1:
                    ne19=input('Corpo sempre quente com incômodo em locais frios? (S/N) ').upper()
                    if ne19=='S':            
            ...
            try:       
                ...
                if a>=3:
                    if 'xerostomia'.upper() not in pureli:
                        ...
                        ne20=input('Corpo sempre quente com incômodo em locais muito quentes? (S/N) ').upper()                
                        if ne20=='S':            
                            dxconff.add(str(dx[199]).capitalize())                
                            break
                        elif ne20=='N':                                        
            ...
            try:               
                ...
                if a>=2:
                    if 'sialorréia'.upper() not in pureli:
                        ...
                        ne21=input('Corpo quente de noite (e somente de noite)? (S/N) ').upper()                
                        if ne21=='S':            
                            dxconff.add(str(dx[200]).capitalize())      
                            break
                        elif ne21=='N':
        ...
        while True:
            try:               
                ...
                if 'língua azul-branca'.upper() in pureli:                
                    a+=1
                if a>=2:
                    ne18=input('Calor em palmas de mãos com grande incômodo? (S/N) ').upper()
                    if ne18=='S':
        ...
        if vector1[3]<m: # P
            if vector1[1]>m: 
                ...
                warn.add('Evitar alimentos amargos e aumentar alimentos picantes por coração dominando pulmão (sintomas: diabetes, poliúria, tosse com escarro amarelo abundante, calor, rubor facial, alopecia e secura de pele)') 
                smt.add('diabetes, poliúria, tosse com escarro amarelo abundante, calor, rubor facial, alopecia e secura de pele'.upper()+' POR FOGO DERRETENDO METAL')
                metal=True
            elif vector1[2]<p:
                smt.add('fleuma em tórax (muco), tosse e fadiga POR '.upper()+'Não-Geração: terra não gerando metal'.upper())
            ...
            smt.add('criação de tumores abdominais, hemorróidas, palpitação, insônia, dispnéia POR '.upper() +'Contra-Dominância: metal drenando fogo'.upper())  
        madeira = False
        if vector1[5] < m:  # F
            if vector1[3] > m:
                dxconff.add('Dominância: metal cortando madeira')
                warn.add('Evitar alimentos picantes e aumentar alimentos ácidos por pulmão dominando fígado (sintomas: fadiga, irritabilidade, distensão, tosse, face esbranquiçada, cãimbras fortes e unhas fracas)')
                smt.add('fadiga, irritabilidade, distensão, tosse, face esbranquiçada, cãimbras fortes e unhas fracas'.upper()+' POR METAL CORTANDO MADEIRA')
                madeira = True
            elif vector1[4] < p:
                smt.add('vertigem, borramento visual, cefaléia POR '.upper(
            ...
            smt.add('medo de situações leves, epistaxe, tosse, asma, distensão de tórax/hipocôndrio POR '.upper() +'Contra-Dominância: madeira drenando metal'.upper())
        terra=False
        if vector1[2]<m: # BP
            if vector1[5]>m:                 
                dxconff.add('Dominância: madeira alimentando terra')
                warn.add('Evitar alimentos ácidos e aumentar alimentos doces por fígado dominando baço (sintomas: dor muscular, dor abdominal, irritabilidade, diarréia, anorexia, face verde, inflamações de pele e lábio descascando)') 
                smt.add('dor muscular, dor abdominal, irritabilidade, diarréia, anorexia, face verde, inflamações de pele e lábio descascando'.upper()+' POR MADEIRA ALIMENTANDO TERRA')         
                terra=True              
            elif vector1[1]<p:
                smt.add('fezes moles, calafrios, fraqueza de membros POR '.upper()+'Não-Geração: fogo não gerando terra'.upper())
                dxconff.add('Não-Geração: fogo não gerando terra')
                terra=True
        elif madeira==False:
            dxconff.add('Contra-Dominância: terra drenando madeira')
            smt.add('polifagia, edema, icterícia, dor, distensão de hipocôndrio POR '.upper() + 'Contra-Dominância: terra drenando madeira'.upper())    
        água=False
        if vector1[4]>m: # R
            if vector1[2]>m:
                dxconff.add('Dominância: terra drenando água')
                warn.add('Evitar alimentos doces e aumentar alimentos salgados por baço dominando rim (sintomas: inchaços, respiração curta, disúria/retenção, face amarela, dor no osso e calvície)')        
                smt.add('inchaços, respiração curta, disúria/retenção, face amarela, dor no osso e calvície'.upper()+' POR TERRA DRENANDO ÁGUA')
                água=True
            elif vector1[3]<p:
                smt.add('borborismos, fezes secas e paradas, tosse, dispnéia, disfonia, asma POR '.upper()+'Não-Geração: metal não gerando água'.upper())
                dxconff.add('Não-Geração: metal não gerando água')      
                água=True
        elif terra==False:
            dxconff.add('Contra-Dominância: água drenando terra')
            smt.add('fezes mole, edema, fadiga, fraqueza de membros, risco de sangramentos intestinais incuráveis (pi de intestino) POR '.upper() +'Contra-Dominância: água drenando terra'.upper())                      
        fogo=False
        if vector1[1]<m: # C
            if vector1[4]>m:
                dxconff.add('Dominância: água apagando fogo')
                warn.add('Evitar alimentos salgados e aumentar alimentos amargos por rim dominando coração (sintomas: edema de tornozelos, lombalgia, frio, vertigem, escarro fino, palpitações, estase de xue)')
                smt.add('edema de tornozelos, lombalgia, frio, vertigem, escarro fino, palpitações, estase de xue'.upper()+' POR ÁGUA APAGANDO FOGO')
                fogo=True
            elif vector1[5]<p:
                smt.add('TOC, timidez, covardia, indecisão, palpitações e insônia matinal POR '.upper()+'Não-Geração: madeira não gerando fogo'.upper())
                dxconff.add('Não-Geração: madeira não gerando fogo')
                fogo=True
        elif água==False:
            dxconff.add('Contra-Dominância: fogo drenando água')
            smt.add('rubor malar, secura noturna (bucal), insônia, lombalgia, sudorese noturna POR '.upper() +'Contra-Dominância: fogo drenando água'.upper())   
        ...
        if vector1[0]>m: # ESTENIA                                        TA
            smt.add('BOCEJOS REPETIDOS, AFASTAR DOS OUTROS POR INCÔMODO NO CORPO, SUSTO COM BARULHOS, PREFERÊNCIA DE JANELAS FECHADAS, VONTADE DE CANTAR E DOR EM JOELHO POR ESTENIA DE FOGO MINISTERIAL')
        elif vector2[0]>m: # ASTENIA                                        TA
            smt.add('CALOR EM MÃO, INCHAÇO NA AXILA, DOR TORÁCICA POR ANSIEDADE POR ASTENIA DE FOGO MINISTERIAL')
        if vector1[1]>m: # ESTENIA                                        C
            if sexo=='F':
                smt.add('DOR EM OMBRO COM SENSAÇÃO DE TORÇÃO, DOR FARÍNGEA EVENTUAL, DOR EM MENTO, TORCICOLO COM DOR EM TÓRAX, PEITO ALTO, DOR EM COSTAS OU SEIOS E FLACIDEZ EM PERNAS POR ESTENIA DE FOGO IMPERIAL')   
            elif sexo=='M':
                smt.add('DOR EM OMBRO COM SENSAÇÃO DE TORÇÃO, DOR FARÍNGEA EVENTUAL, DOR EM MENTO, TORCICOLO COM DOR EM TÓRAX, PEITO ALTO, DOR EM COSTAS OU OMBRO E FRAQUEZA EM PERNAS POR ESTENIA DE FOGO IMPERIAL')                         
        elif vector2[1]>m: # ASTENIA                                        C
            smt.add('DOR AXILAR, POLIDIPSIA, ALTERAÇÃO DE TEMPERATURA DE MÃOS COM DOR EM TÓRAX E LOMBAR COM SENSAÇÃO DE INCHAÇO NAS COSTAS POR ASTENIA DE FOGO IMPERIAL')   
        if vector1[2]>m: # ESTENIA                                        BP
            smt.add('CORPO PESADO, EXCESSO DE FOME, PERNA FRACA, ANDAR CANSA, DOR EM PÉS, ADORMECIMENTO DE PERNAS COM BOCEJOS REPETIDOS, AFASTAR DOS OUTROS QUANDO INCOMODADO COM ALGO, SUSTO COM BARULHOS, DESEJO DE FECHAR JANELAS, DOR EM DOBRA DO JOELHO E VONTADE DE CANTAR POR ESTENIA DE TERRA')               
        elif vector2[2]>m: # ASTENIA                                        BP
            smt.add('FLATULÊNCIAS, REFLUXOS, DIARRÉIA EXPLOSIVA COM RIGIDEZ DE LÍNGUA, TENDÊNCIA DE VÔMITOS, ALÍVIO AO EVACUAR, DESEJO DE DEITAR COM ENGASGOS POR ASTENIA DE TERRA')   
        if vector1[3]>m: # ESTENIA                                        P
            smt.add('DOR EM DENTE, PESCOÇO INCHADO, DOR DE INDICADOR, URINA FORTE COM RESPIRAÇÃO FORTE, TOSSES E GASTRITE (REVERSÃO DE QI), DOR NAS COSTAS, NÁDEGAS E PANTURRILHAS POR ESTENIA DE METAL')
        elif vector2[3]>m: # ASTENIA                                        P
            smt.add('FERIDAS EM PELE, SOLUÇOS, TAQUIPNÉIA, DOR EM CLAVÍCULA, PERDA DE PÊLOS DO CORPO COM FALTA DE AR, CANSAÇO, SENSAÇÃO DE TÓRAX CHEIO E GARGANTA SECA POR ASTENIA DE METAL')
        if vector1[4]>m: # ESTENIA                                        R
            if sexo=='M':
                smt.add('DOR TIBIAL, CORPO PESADO, SUOR NOTURNO, POUCO SÊMEM, IMOBILIDADE DE LOMBAR COM DOR AO APERTAR ENTRE AS DUAS SOMBRANCELHAS, DOR OCULAR E DOR LOMBAR POR ESTENIA DE ÁGUA')
            if sexo=='F':
                smt.add('DOR TIBIAL, CORPO PESADO, SUOR NOTURNO, IMOBILIDADE DE LOMBAR COM DOR AO APERTAR ENTRE AS DUAS SOMBRANCELHAS, DOR OCULAR E DOR LOMBAR POR ESTENIA DE ÁGUA')                
        elif vector2[4]>m: # ASTENIA                                        R
            smt.add('INFELICIDADE/DEPRESSÃO, DOR AO URINAR COM ANOREXIA, DESEJO DE LEVANTAR APÓS SENTAR AO AGUARDAR ALGO, OLHOS ALHEIOS SEM PRESTAR ATENÇÃO, DOR EM LADO INTERNO DE COXA, PERDA DE BRILHO DO CABELO E BABA ESPONTÂNEA POR ASTENIA DE ÁGUA')           
        if vector1[5]>m: # ESTENIA                                        F
            smt.add('SUSPIROS RECORRENTES, ABDOME SEM COR, ÚLCERAS ESPONTÂNEAS, CEFALÉIA TEMPORAL, DOR TORNOZELO EXTERNO, DOR EM COSTELA, IRRITABILIDADE/AGRESSIVIDADE EM CRISES, TENDINITES POR ESTENIA DE MADEIRA')
        elif vector2[5]>m: # ASTENIA                                        F
            smt.add('LOMBALGIA PIORADA AO OLHAR PARA CIMA OU PARA BAIXO, EDEMA GENITAL, DISÚRIA, ENURESE/INCONTINÊNCIA, CÃIMBRAS FREQUENTES, MEDO DE SITUAÇÕES LEVES, VISÃO RUIM, DÉFICIT AUDITIVO LEVE POR ASTENIA DE MADEIRA')
            ...
            try:
                if len(coid)!=0:
                    for i in sorted(coid):
                        print(i)
                print('\n\n')
                lemb = input('Resumo de diagnósticos (digite FIM para sair): ').upper()
                if len(lemb)!=0:
                    if 'FIM' in lemb:
                        print('\n\nEXAME FINALIZADO, INICIANDO PRESCRIÇÃO...')
                        time.sleep(3)
                        only()
                    else:
                        coid.add(lemb)
...
def anam():
    ...
    while True:
        try:
            qq4 = input(
                'Existe problema oftálmico crônico, exceto ametropias (ou seja, miopia, hipermetropia, astigmatismo)? (S/N) ').upper()
            if qq4 == 'S':
    ...
    while True:
        try:
            ...
            if qq5 == 'S':
                questionario.add('Recomendado ponto mu para doença recente correlacionada'.upper())
                break
            if qq5 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq6 == 'S':
                questionario.add('Usar ponto poço para meridiano com paresia'.upper())
                break
            if qq6 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq7 == 'S':
                questionario.add('Usar ponto poço para meridiano com dor'.upper())
                break
            if qq7 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq11 == 'S':
                questionario.add('Ver local de dor e analisar uso de Luo Mai'.upper())
                break
            if qq11 == 'N':
                break
        except:
    ...
    while True:
        try:
            ...
            if qq17 == 4:
                ...
                if qqa == '+':
                    questionario.add('Recomendado tratamento tonificado de Po'.upper())
                    break
                if qqa == '-':
                    questionario.add('Recomendado tratamento sedado de Po'.upper())
                    break
                if qqa != '+' and qqa != '-':
            ...
            if qq17 == 1:
                ...
                if qqaa == 1:
                    questionario.add('Recomendado tratamento sedado de Hun'.upper())
                    break
                if qqaa == 2:
                    questionario.add('Recomendado tratamento tonificado de Hun'.upper())
                    break
            if qq17 == 2:
                questionario.add('Recomendado tratamento tonificado de Xiang'.upper())
                break
            if qq17 == 3:
                questionario.add('Recomendado tratamento tonificado de Yi'.upper())
                break
            if qq17 == 5:
                questionario.add('Recomendado tratamento tonificado de Zhi'.upper())
                break
        except:
            continue
    while True:
        try:
            if tipo_p[15] in pool:
                ...
                if qq18 == 'S':
                    questionario.add('Recomendado tratamento via Dai Mai'.upper())
                    break
                if qq18 == 'N':
                    break
            else:
    ...
    while True:
        try:
            ...
            if qq19 == 'I':
                ...
                if q20 == 'S':
                    questionario.add('Recomendado sedação de yang qiao e tonificar yin qiao'.upper())
                    break
                else:
                    break
            if qq19 == 'H':
                ...
                if qq21 == 'S':
                    questionario.add('Recomendado sedação de yin qiao e tonificar yang qiao'.upper())
                    break
                else:
                    break
            else:
    ...
    while True:
        try:
            ...
            if qq26 == 'N':
                cls()
                print('\n\n\nQUESTIONÁRIO FINALIZADO COM SUCESSO!\n\nFORAM OBTIDAS AS SEGUINTES RECOMENDAÇÕES:\n\n')
                time.sleep(1)
            ...
            if '*' in doc:
                ...
                def sprap(x, y=' '):
                    ...
                    if dx[228] in x:
                        ...
                        f14 = ''
                    return 
        ...
        try:
            if len(seta) < 1:
                ...
                if len(pool3) == 0:
                    ...
                    cob=[item[1:] for item in pool3 if 'B' in item[1] and not 'P' in item[2]]
                ...
                if digprepre.isnumeric() == True:
                    ...
                    if 'FIM' in digpre:
                        ...
                        if homm=='A':
                            ...
                            data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(acompanhante.upper()),str(horadia),str(addr),str(comfx.upper()),str(limpar(pureli)),str(totpul),str(limpar(seta)),str(limpar(acu2))]
                            with open('registro_acupuntura.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)       
                            data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(acompanhante.upper()),str(horadia),str(addr),str(comfx.upper()),str(limpar(pureli)),str(totpul),str(limpar(seta)),str(limpar(acu2)),str(limpar(dxconf)),str(limpar(dxconff))]
                            with open('ailog.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)        
                            data=["'"+str(cpf)+"'",str(nome),str(horadia),str(addr),str(hda)]
                        ...
                        if homm=='D':
                            # ARQUIVAMENTO DE DADOS EM DB
                            data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(acompanhante.upper()),str(horadia),str(addr),'N/D','N/D','N/D',str(limpar(seta)),str(limpar(acu2))]
                            with open('registro_acupuntura.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)       
                            data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(acompanhante.upper()),str(horadia),str(addr),'N/D','N/D','N/D',str(limpar(seta)),str(limpar(acu2)),'N/D','N/D']
                            with open('ailog.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)        
                            data=["'"+str(cpf)+"'",str(nome),str(horadia),str(addr),'N/D']
                            with open('prontuario.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)        
                            os1 = os.path.getsize('registro_acupuntura.csv')/1000000
                        ...
                        while True:
                            try:
                                ...
                                print('\n\n\n\n\n')
                                expli('')
                                qler=input('EXAME SALVO!\n\nDeseja abrir a prescrição salva para realizar agora? (S/N) ').upper()
                                if qler=='S':
                                    ler()
                                elif qler=='N':
                                    zerar()
...
def zerar():
    cls()
    print('\n\n\n\nApagando memória temporária para otimizar Tao...')
    if homm == 'A':
        prepdif.clear()
        h3.clear()
        h8.clear()
        ...
        ver3=False
        ver4=False
        print('\n\nApagando dados temporários de funções de exames...')
        time.sleep(3)
    warn_pun.clear()
    moradia.clear()
    ciddict.clear()
    ...
    lembrete.clear()
    questionario.clear()
    print('\n\nApagando dados temporários de funções globais e de indexação de prescrição...')
    time.sleep(3)
    home()
        ...
        try:
            ...
            if os.path.exists('registro_acupuntura.csv') == True and os.path.exists('ailog.csv') == True and os.path.exists('prontuario.csv') == True:
                ...
                if os.path.exists('registro_acupuntura.csv') == False:
                    ...
                    time.sleep(1)
                    header=['CPF','NOME','SEXO','IDADE','DATA NASCIMENTO','SUF','ACOMPANHANTE','DATA DE EMISSÃO','LOCAL DE ATENDIMENTO','COMPLEIÇÃO','LÍNGUA','PULSO','DIAGNÓSTICOS','PRESCRIÇÃO ACUPUNTURA']
                ...
                if os.path.exists('ailog.csv') == False:
                    ...
                    time.sleep(1)
                    header=['CPF','NOME','SEXO','IDADE','DATA NASCIMENTO','SUF','ACOMPANHANTE','DATA DE EMISSÃO','LOCAL DE ATENDIMENTO','COMPLEIÇÃO','LÍNGUA','PULSO','DIAGNÓSTICOS','PRESCRIÇÃO ACUPUNTURA','DIAGNÓSTICOS DIFERENCIAIS','DIAGNÓSTICOS CONFIRMADOS']
                    with open('ailog.csv', 'w', encoding='UTF8', newline='') as f:
                        writer = csv.writer(f)
                        writer.writerow(header)   
                if os.path.exists('prontuario.csv') == False:
                    # ARQUIVAMENTO DE PRONTUÁRIO
                    print('Criando arquivo de log prontuario.csv...')
                    time.sleep(1)
                    header=['CPF','NOME','DATA DE EMISSÃO','LOCAL DE ATENDIMENTO','HDA']
...
# ☰ du mai ☱ yang qiao mai ☲ dai mai ☳ yang wei mai ☴ yin wei mai ☵ chong mai ☶ yin qiao mai ☷ ren mai
