...
def home():
    while True:
        ...
        if os.path.exists('registro_acupuntura.csv') == True and os.path.exists('ailog.csv') == True and os.path.exists('registro_acupuntura.csv') == True:
            ...
            if os.path.exists('ailog.csv') == True:
                print('BASE DE ANÁLISE: ATIVA')
            else:
                print('BASE DE ANÁLISE: INATIVA')
            if os.path.exists('prontuario.csv') == True:
                print('BANCO DE PRONTUÁRIOS: ATIVA')
            else:
        ...
        if homm == 'A':
            ...
            if str(cpf)==str(tescpf):
                print('CPF validado, procedência: '+origem(oricpf)+'\n\n')
                if os.path.exists('registro_acupuntura.csv') == True:
                ...
                while True:
                    try:
                        ...
                        if pacienteantigo==True:
                            ...
                            if sexo == 'M' or sexo == 'F' and pacienteantigo==False:
                        ...
                        if len(ddtot) == 6 and ddtot.isnumeric() == True:
                            ...
                            pre_especcodcompa_dn = str(input('Digite A para 1900 e B para 2000: '))
        ...
        if homm == 'D':
            ...
            if str(cpf) == str(tescpf):
                ...
                print('Pesquisando em base de dados o CPF:\n')
                df = pd.read_csv("registro_acupuntura.csv")
                d2 = df.loc[df['CPF'].isin(["'"+cpf+"'"])]
                pacienteantigo = False
                if df.loc[df['CPF'].isin(["'"+cpf+"'"])].empty:
                ...
                if pacienteantigo == False:
                    ...
                    time.sleep(2)
                    print('Paciente com cadastro já realizado!')
                    time.sleep(2)
                    print('Pulando tela de cadastro e repetindo dados!\n\n')
                time.sleep(6)
            else:
                print('CPF inválido!')
                time.sleep(4)
...
def ben():
    while True:
        cls()        
        print('\n\nINICIANDO AVALIAÇÃO')
        print('Buscando paciente em prontuários...')
        time.sleep(2)
        print('\n')
        ...
        if len(hda) > 311 or pacienteantigo==False:
            cls()
            print('\n\n\n\n\nESTE EXAME SERÁ AUTOMATICAMENTE REDIRECIONADO PARA QUESTIONÁRIO DE PROTOCOLOS DEVIDO A HISTÓRIA CLÍNICA COMPLEXA OU PACIENTE NOVO!\nO QUESTIONÁRIO BUSCARÁ PROTOCOLOS ADEQUADOS AO SEU TRATAMENTO...\n')
            time.sleep(4)
            cls()
...
# -------------------------------------- VERIFICAÇÃO DE DIAGNÓSTICO - PARTE 4
        ...
        def z(a, b, c): return smt.add(a+' de '+b) if c > 0 else None
            ...
            if len(seta) < 1:
                ...
                if digprepre.isnumeric() == True:
                    ...
                    if 'FIM' in digpre:
                        ...
                        data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(acompanhante.upper()),str(horadia),str(comfx.upper()),str(limpar(pureli)),str(totpul),str(limpar(seta)),str(limpar(acu2))]
                        ...
                        with open('ailog.csv', 'a', encoding='UTF8', newline='') as f:
                            writer = csv.writer(f)
                            writer.writerow(data)        
                        data=["'"+str(cpf)+"'",str(nome),str(horadia),str(hda)]
    ...
    while True:
        try:
            ...
            if os.path.exists('registro_acupuntura.csv') == True and os.path.exists('ailog.csv') == True and os.path.exists('prontuario.csv') == True:
                ...
                time.sleep(1)
                header=['CPF','NOME','SEXO','IDADE','DATA NASCIMENTO','SUF','ACOMPANHANTE','DATA DE EMISSÃO','COMPLEIÇÃO','LÍNGUA','PULSO','DIAGNÓSTICOS','PRESCRIÇÃO ACUPUNTURA']
                ...
                time.sleep(1)
                header=['CPF','NOME','DATA DE EMISSÃO','HDA']
