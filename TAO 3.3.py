    ...
    while True:
        ...
        if homm == 'A' or homm=='D':
            if rede is False:
                ...
                time.sleep(5)                
            cls()
            print('\n\n\n\nTAO VER. '+ver+' USA ALGORÍTMOS DEPENDENTES DO CPF PARA ARQUIVAMENTO CADASTRAL\nInfome o CPF sem traços e pontos para localizar cadastro:\n\n')
            global cpf
            cpf=str(input('CPF: '))
