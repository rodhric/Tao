                ...
                while True:
                    try:
                        ...
                        if len(ddtot) == 6 and ddtot.isnumeric() == True:
                            ...
                            if pre_especcodcompa_dn == 'B':
                                ...
                                if ano_comparador < especcodcompa_dn:
                                    ...
                                    continue
                            dtot = str(ddtot)
                            print('IDADE CALCULADA VIA 6-DIG')
                        # DD/MM/YY
                        if len(ddtot) == 8 and ddtot.isnumeric() == False:
                            ...
                            print('IDADE CALCULADA VIA 8-DIG E SÍMBOLOS')
                        # DDMMYYYY
                        if len(ddtot) == 8 and ddtot.isnumeric() == True:
                            ...
                            print('IDADE CALCULADA VIA 8-DIG')
                        # DD/MM/YYYY
                        if len(ddtot) == 10 and ddtot.isnumeric() == False:
                            ...
                            print('IDADE CALCULADA VIA 10-DIG E SÍMBOLOS')
            ...
            if len(seta) < 1:
                ...
                if digprepre.isnumeric() == True:
                    ...
                    if 'FIM' in digpre:
                        ...
                        print("Base de Análise para Algorítmos: {}MB".format(str(os2)))                 
                        print("Banco de Prontuários: {}MB".format(str(os3)))                 
                        print()
    ...
    while True:
        try:
            ...
            if os.path.exists('registro_acupuntura.csv') == True and os.path.exists('ailog.csv') == True and os.path.exists('prontuario.csv') == True:
                cls()
                print('\n\n\n\nBASE DE DADOS ESTÁ ATIVA!\n\nNÃO É NECESSÁRIO IMPLEMENTAÇÃO NO MOMENTO...')
                time.sleep(8)
                cls()
                break
            else:
