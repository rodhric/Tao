        ...
        try:
            ...
            if os.path.exists("registro_acupuntura.csv") == True and os.path.exists("ailog.csv") == True and os.path.exists("registro_acupuntura.csv") == True and os.path.exists("cadastro.csv") == True:
                ...
                if nu == 0:
                    ...
                    if os.path.exists("registro_acupuntura.csv") == False:
                        print("\n✘ BANCO DE DADOS DE PRESCRIÇÕES: INATIVO")
                    if os.path.exists("ailog.csv") == False:
                        print("\n✘ BASE DE DADOS: INATIVA")
                    if os.path.exists("prontuario.csv") == False:
                        print("\n✘ BANCO DE PRONTUÁRIOS: INATIVO")
                    if os.path.exists("cadastro.csv") == False:
                        print("\n✘ BANCO DE DADOS DE CADASTROS: INATIVO")
            try:
                f = open("loc.txt", "r")
                x = str(f.read())
                if len(x) > 1:
            ...
            if homm == "A" or homm == "D" or homm == "H":
                ...
                if os.path.exists("registro_acupuntura.csv") == False or os.path.exists("ailog.csv") == False or os.path.exists("prontuario.csv") == False or os.path.exists("cadastro.csv") == False:
                    cls()
                    print('\n\n\n\nATENÇÃO! NÃO HÁ CONEXÃO COM SERVIDORE(S) DE BANCO(S) DE DADOS!')
                    time.sleep(3)
                    print('\nPROGRAMA DEPENDE DESTES ARQUIVOS PARA FUNCIONAR')
                    print('RETORNANDO AO MENU')
                    time.sleep(5)              
                    print('\n\nREINICIALIZE OS BANCOS PARA PROSSEGUIR.')
                    time.sleep(4)                    
                    break
                if homm == "A":
                    while True:
                ...
                if pacientecadastrado == True:
                    ...
                    nome = input("Nome Completo (como na identidade): ").upper()
                    ...
                    while True:
                        try:
                            ...
                            if pacientecadastrado == True:
                                ...
                                def i(x):
                                    return print("Feminino") if x == "F"else print("Masculino") if x == "M" else None
                                i(sexo)
                            ...
                            if len(ddtot) == 6:
                                ...
                                if pre_especcodcompa_dn == "A":
                                    ...
                                    subsub_especcodcompa_dn = propro_especcodcompa_dn
                                    global especcodcompa_dn
                            ...
                            if len(ddtot) == 10 and ddtot.isnumeric() == False:
                                ...
                                pro_especcodcompa_dn.split()
                                sufte=int(pro_especcodcompa_dn[0])
                                if sufte==1:
                                    suf='A'
                                elif sufte==2:
                                    suf='B'
                            ...
                            if idi > anoge:  # vei, funcionando
                                ...
                                idint = anonew - idi
                                if idint<1:
                                    idint=int(anoge2)-int(especcodcompa_dn)
                            elif idi <= anoge:  # novin
                                idint = anoge - idi
                                if idint<1:
                                    idint=int(anoge2)-int(especcodcompa_dn)                            
                            ...
                            if uso == True:
                                try:
                                    print('\nIDENTIFICADO ENDEREÇO RÁPIDO:\n'+x)                                 
                                    p = input('USAR COMO ATUAL? (S/N) ').upper()
                                    if p == 'S':
                                        tester=True
                                        addr = x
                                    else:
                                    ...
                                    continue
                            if pacientecadastrado == False and tester==False:
                                cep = input("\nDigite o CEP: ")
                                if len(cep) == 8 and cep.isnumeric() == True:
                                    try:
                                        ...
                                        addr = str(end).upper()
                                        yyt = addr.replace("Ç", "C")
                                        yyt2 = yyt.replace("Á", "A")
                                        yyt3 = yyt2.replace("Ã", "A")
                                        yyt4 = yyt3.replace("É", "E")
                                        yyt5 = yyt4.replace("È", "E")
                                        yyt6 = yyt5.replace("À", "A")
                                        yyt7 = yyt6.replace("Í", "I")
                                        yyt8 = yyt7.replace("Ô", "O")
                                        yyt9 = yyt8.replace("Ú", "U")
                                        addr = str(yyt9)
                                        print(addr)                                       
                                    except:
                                        if rede is True:
                                ...
                                if os.path.exists("registro_acupuntura.csv") == True and tester==False:
                                    df = pd.read_csv("registro_acupuntura.csv")
                            ...
                            if os.path.exists("cadastro.csv") == True:
                                if pacientecadastrado == False:
                                    data = [
                                        "'" + str(cpf) + "'", str(nome), sexo, str(expodn), str(suf)]
    ...
    if df.loc[df['CPF'].isin(["'"+str(cpf)+"'"])].empty:
        ...
        if len(a) == 0:
            ...
            if len(mox) != 0 or len(mox2) != 0:
                print('\nPONTOS COM MOXA:')
                if len(mox) != 0:
                    print(limpar(sorted(mox)))
                if len(mox2) != 0:
                    print(limpar(sorted(mox2)))
            ...
            if len(questionario) > 1:
                ...
                for i in sorted(list(questionario)):
                    print(i.capitalize())
            print(f"\nAGORA -  PROPÍCIO PARA SEDAR: {shu_agora}")
            print(f"AGORA - PROPÍCIO PARA TONIFICAR: {shu_previo}")                    
...
def ben():
        ...
        if os.path.exists("prontuario.csv") == True and pacienteantigo == True:
            ...
            if df.loc[df["CPF"].isin(["'" + str(cpf) + "'"])].empty:
                ...
                if hda_comp > 2:
                    ...
                    print("SEM HISTÓRIA CLÍNICA EM ÚLTIMO ATENDIMENTO...")
                    print("POR FAVOR, REALIZE DESTA VEZ!")
        else:
        ...
        while True:
            try:
                ...
                if comf == 5:
                    ...
                    sta=[]
                    ques1 = input(
                        "\n\nAlteração relativa de qual sensório ou órgão sensorial (qualquer nível de alteração mesmo relativa) \nA-Sensações táteis \nB-Gustação/Boca \nC-Olfato/Nariz \nD-Audição/Orelhas \nE-Visão/Olho \nF-Nenhum "
                    ).upper()
                    x = ques1
                    if x == "A":
                        perfil[0] += 1
                    ...
                    if x == "E":
                        ...
                        sta.append(int(5))
                    ques2 = input(
                        "\n\nQual tipo caracteriza melhor a voz do paciente (mesmo que relativa)? \nA-Risada \nB-Canto \nC-Choro \nD-Gemido \nE-Grito \nF-Nenhum "
                    ).upper()
                    x = ques2
                    if x == "A":
                        perfil[0] += 1
                    ...
                    if x == "E":
                        ...
                        sta.append(int(5))
                    ques3 = input(
                        "\n\nQual tipo caracteriza melhor os sentimentos que recorrentemente aparecem? \nA-Alegria \nB-Introspecção \nC-Tristeza \nD-Medo \nE-Raiva/Indignação \nF-Nenhum "
                    ).upper()
                    x = ques3
                    if x == "A":
                        perfil[0] += 1
                    ...
                    if x == "E":
                        perfil[4] += 1
                        sta.append(int(5))
                    ques5 = input("\n\nQual destes fatores apresenta maior aversão ou incômodo? \nA-Local quente sem ar condicionado \nB-Saunas/piscinas/estufas/ locais abafados \nC-Local muito seco \nD-Local muito frio com ar no máximo \nE-Ventilador ou o vento do ar condicionado \nF-Nenhum ").upper()
                    x = ques5
                    if x == "A":
                        perfil[0] += 1
                        sta.append(int(1))
                    ...
                    if x == "E":
                        perfil[4] += 1
                        sta.append(int(5))
                    ques6 = input("\n\nComo anda seu comportamento socialmente: \nA-Muito social; \nB-Indiferente; \nC-Pouco socializável; \nF-Nenhum ").upper()
                    x = ques6
                    if x == "A":
                        perfil[0] += 1
                        sta.append(int(1))
                    if x == "B":
                        while True:
                            try:
                                ques6a = input("\n\nA-Não perde tempo defendendo opinião e nem briga (pouco comunicativo/a); \nB-Opiniões fortes (reativo/a) \nC-Comunicativo/a sem reatividade").upper()
                                x = ques6a
                                if x == "C":
                                    perfil[1] += 1
                                    sta.append(int(2))
                    ...
                    if x == "C":
                        perfil[2] += 1
                        sta.append(int(3))
                    ques7 = input("\n\nAlgum destes problemas? \nA-Áudios longos/ fala repetitiva, aftas ou bruxismo, taquicardias súbitas; \nB-Lábios feridos, não sente gosto de comida ou problema súbito de emagrecer ou engordar; \nC-Pêlos com problema (barba ou alopecia - calvície não conta) ou anosmia (não sente alguns cheiros) ou problemas de pele recentes (machucados); \nD-Cabelo (seco/caindo) ou impotência sexual masculina ou surdez ou problema no osso recente; \nE-Unhas (fungo, fraca, crescimento lento) ou no olho (secura, irritação) ou mesmo câimbras com dores musculares; \nF-Nenhum ").upper()
                    x = ques7
                    if x == "A":
                        perfil[0] += 1
                        sta.append(int(1))
                    ...
                    if x == "E":
                        perfil[4] += 1
                        sta.append(int(5))
                    ques8 = input("\n\nAlguma destas? \nA-Pensamento incessante até esquece o que pensou, atrapalha sono pensar assim; \nB-Parece que anda esquecido(a) demais ou anda estudando muito e acha que por isso está esquecido(a); \nC-Coceiras e alergias recorrentes; \nD-Desmotivado(a) como antes e nem tem planos a longo prazo (mas não é depressão é desestímulo); \nE-Alfa! Assume controle da vida, toma responsabilidades e até briga quando as coisas desandam (ou pode ser muito indeciso(a), um ou outro); \nF-Nenhum ").upper()
                    x = ques8
                    if x == "A":
                        perfil[0] += 1
                        sta.append(int(1))
                    ...
                    while True:
                        try:
                            pre_ques9=input('\n\nPreferência por água gelada? \nA-Sempre \nB-Tanto faz ou nem gosta ').upper()
                            if pre_ques9=='A':
                                ques9 = input("\n\nQual alimento tem compulsão e prefere? \nA-Salgados (coxinha/ frituras e bolo salgado); \nB-Alimentos fortes (limão ou algum alimento que as pessoas assustam); \nC-Amargos (café, água tônica, ou algum alimento que só a pessoa gosta); \nD-Doces (balas/ tortas/ biscoitos); \nE-Picantes (pimentas); \nF-Nenhum ").upper()
                                warn.add('SINAIS DE CALOR CHEIO DA COMPLEIÇÃO')
                            elif pre_ques9=='B':
                                ques9= input("\n\nQual alimento tem compulsão e prefere? \nA-Amargos (café, água tônica, ou algum alimento que só a pessoa gosta); \nB-Doces (balas/ tortas/ biscoitos); \nC-Picantes (pimentas); \nD-Salgados (coxinha/ frituras e bolo salgado); \nE-Alimentos fortes (limão ou algum alimento que as pessoas assustam); \nF-Nenhum ").upper()
                            else:
                                continue
                            x = ques9
                            if x == "A":
                            ...
                            continue
                    w=int(round(statistics.median(sta)))
                    if int(perfil[0]) > 2 or w==1:
                        comfx = "Compleição de Coração"
                        export4 = 1
                        break
                    elif int(perfil[1]) > 2 or w==2:
                        comfx = "Compleição de Baço"
                        export4 = 2
                        break
                    elif int(perfil[2]) > 2 or w==3:
                        comfx = "Compleição de Pulmão"
                        export4 = 3
                        break
                    elif int(perfil[3]) > 2 or w==4:
                        comfx = "Compleição de Rim"
                        export4 = 4
                        break
                    elif int(perfil[4]) > 2 or w==5:
                        comfx = "Compleição de Fígado"
                        export4 = 5
                        break
    ...
    """
        cls()
        # dxa, dxc, cód. frio cheio
        def cac (a,c,y):
            x=int(2*c+(a-c)*3+c*2-8)
            if x==3:
                return pct.add(dx[int(y - 12)])  # calor cheio
            if x==-1:    
                return pct.add(dx[int(y - 6)])  # calor vazio
            if x==1:
                return pct.add(dx[int(y)])  # frio cheio
            if x==-3:
                return pct.add(dx[int(y + 6)])  # frio vazio
            if x==2:
                return pct.add(dx[int(y - 12)])  # calor cheio
            if x==-4:
                return pct.add(dx[int(y - 6)])  # calor vazio
            ...
            if x==-2:
                return pct.add(dx[int(y + 6)])  # frio vazio
        # 180 Frio Cheio em Canal de Coração e Intestino Delgado
        # 181 Frio Cheio em Canal de Baço/Pâncreas e Estômago
        # 182 Frio Cheio em Canal de Pericárdio e Triplo Aquecedor
        # 183 Frio Cheio em Canal de Pulmão e Intestino Grosso
        # 184 Frio Cheio em Canal de Rim e Bexiga
        # 185 Frio Cheio em Canal de Fígado e Vesícula Biliar
        ...
        # 180 Frio Cheio em Canal de Coração e Intestino Delgado
        # 184 Frio Cheio em Canal de Rim e Bexiga
        # 185 Frio Cheio em Canal de Fígado e Vesícula Bilia
        ...
        if d3c == 3 and a == 0:
            ...
            if q3 == "S":
                ...
                y = dx[264]
                e(x, y)
            q4 = input("\nAusência de sede mesmo se lábio seco? (S/N) ").upper()
            if q4 == "S":
            ...
            try:
                ...
                if tipo_p[1] in pool:
                    ...
                    if tipo_p[13] in pool or tipo_p[14] in pool:
                        ...
                        ne1 = input("\nCalor contínuo com intolerância a frio e dores em pescoço/cervical ou cabeça? (S/N) ").upper()
                        if ne1 == "S":
                            ne2 = input("\nO que incomoda mais? O vento(A), o frio(B) ou a sede(C)? ").upper()
                            if ne2 == "A":
                                dxconff.add(
        ...
        while True:
            try:
                ...
                if tipo_p[14] in pool:
                    a += 1
                if a >= 2:
                    ne4 = input("\nSensação de corpo quente com aversão a calor e suores excessivos diários? (S/N) ").upper()
                    if ne4 == "S":
                        ne5 = input("\nCome bem e sempre tem fome nas refeições? (S/N) ").upper()
                        if ne5 == "S":
                            dxconff.add(
        ...
        while True:
            try:
                if tipo_p[2] in pool or tipo_p[14] in pool:
                    ne6 = input("\nOcorre alteração de paladar com gosto amargo? (S/N) ").upper()
                    ne7 = input("\nNo último mês ocorreu olhar fixo e parado sem pensar em nada involuntariamente (crise de ausência)? (S/N) ").upper()
                    if ne6 == "S" or ne7 == "S":
                        ne8 = input("\nSente continuamente pressão localizada em peito ou costela como se um músculo tivesse travado? (S/N) ").upper()
                        if ne8 == "S":
                            dxconff.add(
                            ...
                            ne9 = input("\nDe repente, anima em falar demais com pessoas percebendo eventualmente (mensagens de voz longas)? (S/N) ").upper()
                            if ne9 == "S":
                                dxconff.add(
                                    str(dx[264] + " " + dx[204]).capitalize())
                                break
        ...
        while True:
            try:
                ne10 = input("\nDor abdominal com diarréias recorrentres e únicas e tendência de beber pouca sede ao longo do dia, de modo geral? (S/N) ").upper()
                ...
                if ne10 == "S":
                    a += 1
                if a >= 2:
                    ne11 = input("\nIrritação diária com diarréias que duram pelo menos 1 semana porém sumindo sozinha por semanas e reaparecendo do mesmo jeito? (S/N) ").upper()
                    if ne11 == "S":
                        dxconff.add(str(dx[265] + " " + dx[205]).capitalize())
                        break
                    elif ne11 == "N":
                        ne12 = input("\nDor em braços ou pernas, como se estivessem cansadas (sendo muito frequente o sintoma)? (S/N) ").upper()
                        if ne12 == "S":
                            dxconff.add(
        ...
        while True:
            try:
                ...
                if ne10 == "S":
                    a += 1
                if a >= 2:
                    ne13 = input("\nExcesso de sono diariamente com tendência de ficar exausto? (S/N) ").upper()
                    ne14 = input("\nRaiva e descontrole sem motivo aparente e subitamente, em momentos de calma, sendo em outros momentos, presente uma vontade de vomitar que não é bem náusea nem dor? (S/N) ").upper()
                    if ne13 == "S" or ne14 == "S":
                        dxconff.add(
                            str("Shang Han Lun/ " + dx[206]).capitalize())
                        break
        ...
        while True:
            try:
                ...
                # if ne15=='S':
                ne15 = input("\nDeseja uma comida, ao ter a comida perde-se total apetite (dor/saciedade/incômodo/nojo)? (S/N) ").upper()
                if ne15 == "S":
                    ne17 = input("\nEm dias quentes quando se está atarefado(a) e na correria suando, ocorre diarréia súbida muito forte que some após episódio? (S/N) ").upper()
                    if ne17 == "S":
                    ...
                    ne16 = input("\nExiste sensação eventual de algo quente subindo pelo tórax? (S/N) ").upper()
                    if ne16 == "S":
                        ne17 = input("\nEm dias agitados, ocorre diarréia única? (S/N) ").upper()
                        if ne17 == "S":
                            dxconff.add(
        ...
        while True:
            try:
                ...
                if "saburra branca".upper() in pureli:
                    a += 1
                if a >= 1:
                    ne19 = input("\nCorpo sempre quente com incômodo em locais frios? (S/N) ").upper()
                    if ne19 == "S":
            ...
            try:
                ...
                if a >= 3:
                    if "xerostomia".upper() not in pureli:
                        ...
                        ne20 = input("\nCorpo sempre quente com incômodo em locais muito quentes? (S/N) ").upper()
                        if ne20 == "S":
                            dxconff.add(str(dx[199]).capitalize())
                            break
                        elif ne20 == "N":
            ...
            try:
                ...
                if a >= 2:
                    if "sialorréia".upper() not in pureli:
                        ...
                        ne21 = input("\nCorpo quente de noite (e somente de noite)? (S/N) ").upper()
                        if ne21 == "S":
                            dxconff.add(str(dx[200]).capitalize())
                            break
                        elif ne21 == "N":
        ...
        while True:
            try:
                ...
                if "língua azul-branca".upper() in pureli:
                    a += 1
                if a >= 2:
                    ne18 = input("\nCalor em palmas de mãos com grande incômodo? (S/N) ").upper()
                    if ne18 == "S":
        ...
        def ytt(x):
            ...
            if int(x) == 3:
                return "↺ "
        pul = [
            {"ANÁLISE": "METAL", "⚊": yt(d1a), "血 ": ytt(d1b), "⚋": yt(d1c)},
            {"ANÁLISE": "TERRA", "⚊": yt(d2a), "血 ": ytt(d2b), "⚋": yt(d2c)},
            {"ANÁLISE": "MINISTERIAL","⚊": yt(d3a),"血 ": ytt(d3b),"⚋": yt(d3c)},
            {"ANÁLISE": "IMPERIAL","⚊": yt(e1a),"血 ": ytt(e1b),"⚋": yt(e1c)},
            {"ANÁLISE": "MADEIRA", "⚊": yt(e2a), "血 ": ytt(e2b), "⚋": yt(e2c)},
            {"ANÁLISE": "ÁGUA", "⚊": yt(e3a), "血 ": ytt(e3b), "⚋": yt(e3c)},
        ]
        pul2 = [
        ...
        try:
            ...
            if "*" in doc:
                ...
                if len(seta) != 0:
                    ...
                    print('COLETANDO MÉTODOS E QUANTIDADES DE AGULHAS')
                    time.sleep(0.9)       
                    cls()
                    print("\n\n\n\nPRESCRIÇÃO DE ACUPUNTURA:\n")                                                  
                    print('REFINANDO PONTOS SEGUNDO ORIENTAÇÕES\n')              
                    time.sleep(1.6)  
                    cls()
                    print("\n\n\n\nPRESCRIÇÃO DE ACUPUNTURA:\n")                                          
                    if index >= 6:
                        ...
                        print("MÉTODO DE PRESCRIÇÃO: COMPLETA\n(14 AGULHAS POR DIAGNÓSTICO)\n\n")
                    elif index <= 3:
                        p = "+"  # gerar 1-2 prescrições
                        print("MÉTODO DE PRESCRIÇÃO: MÍNIMA\n(2 AGULHAS POR DIAGNÓSTICO)\n\n")
                    else:
                        p = "++"  # gerar 4-5 prescrições
                        print("MÉTODO DE PRESCRIÇÃO: RESUMIDA\n(8 AGULHAS POR DIAGNÓSTICO)\n\n")
                    time.sleep(2.3)                       
                    cls()
                    """
        ...
        try:
            if len(seta) < 1:
                    ...
                    if homm == "A":
                        ...
                        if len(questionario) > 0:
                            ...
                            for i in sorted(list(questionario)):
                                print(i.capitalize())
                    if len(lembrete) != 0:
                        print("\n\nLEMBRETES DE CONSULTAS: ", end='')
                        print(limpar(sorted(list(lembrete))))
                    if len(dxcid) != 0:
                        print('\nCID-11: ', end='')
                ...
                if digprepre.isnumeric() == True:
                    ...
                    if "FIM" in digpre:
                        ...
                        cls()
                        print("\n\n\n\nSALVANDO EM BANCO DE DADOS:\n\n")                                                  
                        print('ARQUIVANDO PRESCRIÇÃO')                                               
                        time.sleep(1.4)        
                        cls()
                        print("\n\n\n\nSALVANDO EM BANCO DE DADOS:\n\n")                                                               
                        print('APRENDENDO O PADRÃO DIAGNÓSTICO PARA AI')                                               
                        time.sleep(2.3)                                                                                                        
                        if homm == 'A':
                            data = ["'" + str(cpf) + "'", str(nome), sexo, str(idd), str(expodn), str(pre_especcodcompa_dn), str(horadia), str(addr).upper(), str(comfx.upper()), str(
                            ...
                            with open('ailog.csv', 'a', encoding='UTF8', newline='') as f:
                                for i in range(int(len(ldx))):
                                    writer = csv.writer(f)
                                    writer.writerow([int(ldx[i]), int(aix5), int(export1), int(export2), int(d1a), int(d1b), int(d1c), int(d2a), int(d2b), int(d2c), int(d3a), int(d3b), int(d3c), int(e1a), int(
                                        e1b), int(e1c), int(e2a), int(e2b), int(e2c), int(e3a), int(e3b), int(e3c), int(export3), int(export4), int(export5), int(aix1), int(aix2), int(aix3), int(aix4)])
                            data = ["'" + str(cpf) + "'", str(nome), str(horadia), str(addr).upper(), "'" + str(hda) + "'"]
                            with open('prontuario.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)               
                        if homm == 'D':
                            data = ["'" + str(cpf) + "'", str(nome), sexo, str(idd), str(expodn), str(pre_especcodcompa_dn), str(horadia), str(addr).upper(), 'N/D', 'N/D', 'N/D', str(
                                limpar(seta)), str(limpar(pool3)), ' ', ' ', ver]  # anula recomendações e métodos (warn_pun e questionario) ao fim
                            with open('registro_acupuntura.csv', 'a', encoding='UTF8', newline='',) as f:
                                writer = csv.writer(f)
                                writer.writerow(data)
                            data = ["'" + str(cpf) + "'", str(nome),
                                    str(horadia), str(addr).upper(), 'N/D']
                            with open('prontuario.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)
                        ...
                        osme=int(os1)+int(os2)+int(os3)+int(os4)
                        osme=int(osme)/4
                        cls()
                        if int(osme)<1:
                            os1 = os.path.getsize('registro_acupuntura.csv') / 1000
                            os2 = os.path.getsize('ailog.csv') / 1000
                            os3 = os.path.getsize('prontuario.csv') / 1000
                            os4 = os.path.getsize('cadastro.csv') / 1000    
                            osme=int(os1)+int(os2)+int(os3)+int(os4)
                            osme=int(osme)/4
                            if int(osme)<1:
                                os1 = os.path.getsize('registro_acupuntura.csv')
                                os2 = os.path.getsize('ailog.csv')
                                os3 = os.path.getsize('prontuario.csv')
                                os4 = os.path.getsize('cadastro.csv')                                  
                                print("\n\n\n\nESTADO DOS BANCOS DE DADOS:\n\n")                                                               
                                print('PRESCRIÇÕES: {} BYTES'.format(str(round(int(os1)))))
                                print('BASE DE INTELIGÊNCIA ARTIFICIAL: {} BYTES'.format(str(round(int(os2)))))
                                print('PRONTUÁRIOS: {} BYTES'.format(str(round(int(os3)))))
                                print('BANCO DE CADASTRO: {} BYTES'.format(str(round(int(os4)))))
                                print()
                                time.sleep(2)
                                print('\nREABRINDO A PRESCRIÇÃO SALVA...')                                                      
                            else:
                                print("\n\n\n\nESTADO DOS BANCOS DE DADOS:\n\n")                                                               
                                print('PRESCRIÇÕES: {}KB'.format(str(round(int(os1)))))
                                print('BASE DE INTELIGÊNCIA ARTIFICIAL: {}KB'.format(str(round(int(os2)))))
                                print('PRONTUÁRIOS: {}KB'.format(str(round(int(os3)))))
                                print('BANCO DE CADASTRO: {}KB'.format(str(round(int(os4)))))
                                print()
                                time.sleep(2)
                                print('\nREABRINDO A PRESCRIÇÃO SALVA...')                           
                        elif int(osme)<1050:
                            print("\n\n\n\nESTADO DOS BANCOS DE DADOS:\n\n")                                                               
                            print('PRESCRIÇÕES: {}MB'.format(str(round(int(os1)))))
                            print('BASE DE INTELIGÊNCIA ARTIFICIAL: {}MB'.format(str(round(int(os2)))))
                            print('PRONTUÁRIOS: {}MB'.format(str(round(int(os3)))))
                            print('BANCO DE CADASTRO: {}MB'.format(str(round(int(os4)))))
                            print()
                            time.sleep(2)
                            print('\nREABRINDO A PRESCRIÇÃO SALVA...')                           
                        else:
                            os1 = os.path.getsize('registro_acupuntura.csv') / 1000000000
                            os2 = os.path.getsize('ailog.csv') / 1000000000
                            os3 = os.path.getsize('prontuario.csv') / 1000000000
                            os4 = os.path.getsize('cadastro.csv') / 1000000000              
                            print("\n\n\n\nESTADO DOS BANCOS DE DADOS:\n\n")                                                               
                            print('PRESCRIÇÕES: {}GB'.format(str(round(int(os1)))))
                            print('BASE DE INTELIGÊNCIA ARTIFICIAL: {}GB'.format(str(round(int(os2)))))
                            print('PRONTUÁRIOS: {}GB'.format(str(round(int(os3)))))
                            print('BANCO DE CADASTRO: {}GB'.format(str(round(int(os4)))))
                            print()
                            time.sleep(2)
                            print('\nREABRINDO A PRESCRIÇÃO SALVA...')                           
                        time.sleep(3.5)                        
            ...
            while True:
                try:
                    ...
                    time.sleep(10)
                    d = input(
                        'APERTE DIGITE X PARA PROSSEGUIR\n').upper()
                    if d == 'X':
                        break
                    else:
                        continue
...
def lista():
    cls()
    print('\n\n\n\n\n\nATENÇÃO!\n\nTEXTOS LONGOS E SEPARADOS POR ÍNDICE, VERIFIQUE A PROGRESSÃO DA LEITURA\n')
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\nÍNDICE: \n[X] TIPOLOGIA DE PULSOS  \n[ ] OPERACIONALIZAÇÃO EXTRAMERIDIANOS  \n[ ] MÉTODOS DE ACUPUNUTURA  \n[ ] CID-11 PARA ACUPUNTURA E MEDICINA CHINESA  \n[ ] OPERACIONALIZAÇÃO DE DIAGNÓSTICOS   \n[ ] PARAMETRIZAÇÃO DE BANCO DE DADOS DE AI')
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\n\n\n\n\n\n\n\n')
    print("\n\nTIPOLOGIA DE PULSOS")
    ...
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\nÍNDICE: \n[ ] TIPOLOGIA DE PULSOS  \n[X] OPERACIONALIZAÇÃO EXTRAMERIDIANOS  \n[ ] MÉTODOS DE ACUPUNUTURA  \n[ ] CID-11 PARA ACUPUNTURA E MEDICINA CHINESA  \n[ ] OPERACIONALIZAÇÃO DE DIAGNÓSTICOS   \n[ ] PARAMETRIZAÇÃO DE BANCO DE DADOS DE AI')
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\n\n\n\n\n\n\n\n')
    ...
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\nÍNDICE: \n[ ] TIPOLOGIA DE PULSOS  \n[ ] OPERACIONALIZAÇÃO EXTRAMERIDIANOS  \n[ ] MÉTODOS DE ACUPUNUTURA  \n[X] CID-11 PARA ACUPUNTURA E MEDICINA CHINESA  \n[ ] OPERACIONALIZAÇÃO DE DIAGNÓSTICOS   \n[ ] PARAMETRIZAÇÃO DE BANCO DE DADOS DE AI')
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\n\n\n\n\n\n\n\n')
    print("\n\nCID-11 DE MTC")
    ...
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\nÍNDICE: \n[ ] TIPOLOGIA DE PULSOS  \n[ ] OPERACIONALIZAÇÃO EXTRAMERIDIANOS  \n[ ] MÉTODOS DE ACUPUNUTURA  \n[ ] CID-11 PARA ACUPUNTURA E MEDICINA CHINESA  \n[X] OPERACIONALIZAÇÃO DE DIAGNÓSTICOS   \n[ ] PARAMETRIZAÇÃO DE BANCO DE DADOS DE AI')
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\n\n\n\n\n\n\n\n')
    ...
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\nÍNDICE: \n[ ] TIPOLOGIA DE PULSOS  \n[ ] OPERACIONALIZAÇÃO EXTRAMERIDIANOS  \n[ ] MÉTODOS DE ACUPUNUTURA  \n[ ] CID-11 PARA ACUPUNTURA E MEDICINA CHINESA  \n[ ] OPERACIONALIZAÇÃO DE DIAGNÓSTICOS   \n[X] PARAMETRIZAÇÃO DE BANCO DE DADOS DE AI')
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nEXPLICAÇÃO DE BANCO DE DADOS AI:\nRESPECTIVAMENTE PARA BASE DE TREINAMENTOS DE ALGORÍTMOS NOS DADOS ABAIXO\n[0] DIAGNÓSTICO(S)\n    DIAGNÓSTICOS INDIVIDUAIS ITERADOS\n    UM EXAME PODE FORNECER MÚLTIPLAS ENTRADAS\n\n[1] QUANTIDADE DE DIAGNÓSTICO(S)\n    CONTROLE DE DADOS DE DIAGNÓSTICOS: PRIMEIRA FUNÇÃO LÓGICA (INDEXADA DIFERENTE PARA MELHOR VISUALIZAÇÃO)\n    >>> AIX5\n        Quantidade de diagnósticos\n        int(len(seta)) (3 se x x x) (2 se x x) (1 se x) (6 se x x x x x x)\n        sendo, len a quantidade de diagnósticos x    \n        CONTROLE LÓGICO: PRIORIDADE DO DIAGNÓSTICO INDIVIDUAL QUANTO MENOR FOR\n\n[2] LÍNGUA\n    ÍNGUA (NUMERADA CONFORME PARAMETRIZAÇÃO DO PROGRAMA) ELEVADA AO QUADRADO\n    >>> EXPORT1\n\n[3] SEXO-IDADE\n    SEXO E IDADE CLASSIFICADOS NUMERICAMENTE\n    SEXO M: IDADE*1, SEXO F: IDADE**2\n    >>> EXPORT2\n\nPULSOLOGIA CHINESA\nD1=PULMÃO /D2=BAÇO /D3=TRIPLO AQUECEDOR /E1=CORAÇÃO /E2=FÍGADO /E3=RINS\n    [4] D1A\n    [5] D1B\n    [6] D1C\n    [7] D2A\n    [8] D2B\n    [9] D2C\n    [10] D3A\n    [11] D3B\n    [12] DD3C\n    [13] E1A\n    [14] E1B\n    [15] E1C\n    [16] E2A\n    [17] E2B\n    [18] E2C\n    [19] E3A\n    [20] E3B\n    [21] E3C\n\n[22] TIPOS DE PULSOS\n    ANÁLISES NÃO MERIDIONAIS E SIM DE TIPOS DE PULSOS (PULSO FINO, CURTO, LONGO, RÁPIDO, VAZIO, ENCHARCADO, CORDA...)\n    REALIZADA SOMA DE QUADRADOS SEGUNDO A REPRESENTAÇÃO NUMÉRICA INFORMADA EM PARATRIZAÇÃO DO PROGRAMA\n    >>> EXPORT3\n\n[23] COMPLEIÇÃO INFORMADA\n    ANÁLISE DA PRESCRIÇÃO\n    >>> EXPORT4\n\n[24] COMPLEIÇÃO RENYING\n    ANÁLISE SECUNDÁRIA DE CONTROLE CALCULADA SEGUNDO A TÉCNICA DESCRITA EM CLÁSSICO INTERNO DA MEDICINA INTERNA DO IMPERADOR AMARELO\n    >>> EXPORT5\n\n[25] SOMA DOS QUADRADOS DE DIAGNÓSTICO(S)\n    CONTROLE DE DADOS DE DIAGNÓSTICOS: PRIMEIRA FUNÇÃO LÓGICA\n    >>> AIX1\n        Soma dos quadrados\n        x**2+x**2+x**2\n        sendo, x(n) = os números dos diagnóstico(s) selecionado(s)\n\n[26] SOMA DE DIAGNÓSTICO(S)\n    CONTROLE DE DADOS DE DIAGNÓSTICOS: SEGUNDA FUNÇÃO LÓGICA\n    >>> AIX2\n        Soma\n        x+x+x+x\n        sendo, x(n) = os números dos diagnóstico(s) selecionado(s)\n\n[27] PRODUTO DA SOMA DE 135 SUBTRAIDOS ADENDOS DE DIAGNÓSTICO(S)\n    CONTROLE DE DADOS DE DIAGNÓSTICOS: TERCEIRA FUNÇÃO LÓGICA\n    >>> AIX3\n        Soma de 135 subtraindo adendos\n        135-x + 135-x + 135-x + 135-x\n        sendo, x(n) = os números dos diagnóstico(s) selecionado(s)\n\n[28] PRODUTO DA SOMA DE ADENDOS SUBTRAÍDOS DE 180 DE DIAGNÓSTICO(S)\n    CONTROLE DE DADOS DE DIAGNÓSTICOS: QUARTA FUNÇÃO LÓGICA\n    >>> AIX4\n        Soma de adendos subtraindo 180\n        x-180+x-180+x-180\n        sendo, x(n) = os números dos diagnóstico(s) selecionado(s)\n        CONTROLE LÓGICO: MUITOS DIAGNÓSTICOS ENTRE 160-200, SENDO ESSE PARÂMETRO PARA DETECTAR DIAGNÓSTICOS INCOMUNS/RAROS\n\n\nEXEMPLOS DE DADOS:\nDIAGNÓSTICO(S),QUANTIDADE DE DIAGNÓSTICO(S),LÍNGUA,SEXO-IDADE,D1A,D1B,D1C,D2A,D2B,D2C,D3A,D3B,D3C,E1A,E1B,E1C,E2A,E2B,E2C,E3A,E3B,E3C,PULSOS,COMPLEIÇÃO,COMPLEIÇÃO RENYING,SOMA DOS QUADRADOS DE DIAGNÓSTICO(S),SOMA DE DIAGNÓSTICO(S),PRODUTO DA SOMA DE 135 SUBTRAIDOS ADENDOS DE DIAGNÓSTICO(S),PRODUTO DA SOMA DE ADENDOS SUBTRAÍDOS DE 180 DE DIAGNÓSTICO(S)\n2,4,394,1225,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,373,1,4,51478,318,222,-402\n188,4,394,1225,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,373,1,4,51478,318,222,-402\n127,4,394,1225,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,373,1,4,51478,318,222,-402\n1,4,394,1225,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,373,1,4,51478,318,222,-402\n\n')
    finalque = input("\nAperte qualquer tecla para continuar: ")
    cls()
    print('\n\n\n\nLEITURA FINALIZADA, RETORNANDO AO MENU...')
    time.sleep(3)
...
def gerar_arquivos():
    while True:
        try:
            ...
            time.sleep(2)                   
            if os.path.exists("registro_acupuntura.csv") == True and os.path.exists("ailog.csv") == True and os.path.exists("prontuario.csv") == True and os.path.exists("cadastro.csv") == True:
                cls()
                ...
                print("\n\n\n\n☁  PROCESSANDO UPLOAD VIA CÓDIGO\n\n")
                print('[▬▬▬▬▬▬▬▬▬▬▬▬▬]\n')
                print("RESTAURAÇÃO FINALIZADA COM SUCESSO!")
...
anoge = int(anogen, 10)
global anoge2
anogeno = ger_hor_atu.strftime("%Y")
anoge2 = int(anogeno, 10)
...
atualizações = {
    ...
    'TAO 5.1.5': 'VERSÃO ESTÁVEL COM IMPLANTAÇÕES DE LÓGICAS QUE FUNCIONAM, RETIRADAS OUTRAS COM ANOMALIAS COMO FUNÇÃO ARITMÉTICA DE TERCEIRO GRAU EM LOOPS DE DIAGNÓSTICOS QUE GERAVAM SOBRECARREGAMENTO DE MEMÓRIA E ERRO',
    ...
    'TAO 5.1.6a': 'AJUSTE DE FUNÇÃO WRITER VIA PANDAS COM NOVA LISTA GLOBAL PARA INDEXAR LOOP CURTO DE DIAGNÓSTICOS USANDO PROCESSOS CONCORRENTES',
    'TAO 5.2.0': 'IMPLANTADA E TESTADA COM SUCESSO A GERAÇÃO DE BANCO DE DADOS PARA ALGORÍTMOS AI COM PARAMETRIZAÇÃO DIAGNÓSTICA INDIVIDUAL E PARAMETRIZADA EM 5 FUNÇÕES ARITMÉTICAS DE PRIMEIRO E SEGUNDO GRAU',
    'TAO 5.2.1': 'AJUSTADO ERRO DE ENDEREÇO POR USAR ARQUIVO ERRADO E GERAR VALOR BLANK AUTOMATICAMENTE E ERRO DE DATAÇÃO POR ALTERNÂNCIA DE DÉCADAS QUANDO FORNECIDO DATAS DD/MM/YY',
    'TAO 5.2.2': 'AJUSTE DE CONEXÃO DE IPHONE (IOS), AJUSTE DE FUNÇÃO LÓGICA COM STRING MODIFICANDO NOME DA PESSOA, AJUSTE DE TABULAÇÃO DE WEN BING E SHANG HANS', 
    'TAO 5.2.3': 'AJUSTE DE FUNÇÕES PARA IOS GERANDO ERRO POR PYTHON FILE METHODS NO IOS',        
    'TAO 5.2.4': 'BLOQUEIO DE USO DE PROGRAMA SEM BANCO DE DADOS DEVIDO A ERROS FATAIS APÓS IMPLEMENTAÇÃO DE DADOS FORNECIDOS PELOS MESMOS E NÃO MAIS SOLICITADOS PARA RODAREM BEM COMO ARMAZENAMENTO TEMPORÁRIO DE STRINGS DURANTE A EXECUÇÃO SEM USO DE MEMÓRIA RAM PARA EVITAR PERDAS DE INFORMAÇÕES DEMORADAS', 
    'TAO 5.2.5': 'AJUSTE DE SEXO PARA CÁLCULOS GERRANDO VALORES 0 EM SEXO FEMININO, AJUSTE DE FUNÇÃO SOBREPOSTA DE IDADE COM MESMA STRING EM USO GERANDO VALORES SOBREPOSTOS COM ERROS AO CÁLCULO DE EXPOSIÇÃO DE DATA DD/MM/90 (1990 OU 2090?) AGORA CALCULANDO CORRETAMENTE, AJUSTE DE RETIRADA DE PRESCRIÇÕES ITERADAS',     
    'TAO 5.2.6': 'ADIÇÃO DE FÓRMULA PARA DETECCÇÃO DE DIAGNÓSTICO, SENDO: INT(2*C+(A-C)*3+C*2-8) [A=PULSO SUPERFICIAL E C=PULSO PROFUNDO, SENDO PERMITIDOS 1 (FRACO), 2 (NORMAL) E 3 (FORTE)] [RESULTADOS: 3=CALOR CHEIO, -1=CALOR VAZIO, 1=FRIO CHEIO, -3=FRIO VAZIO, 2=CALOR CHEIO, -4=CALOR VAZIO COM COLAPSO, 4=CALOR CHEIO COM APOSTASIA, -2=FRIO VAZIO, 0= PULSO NORMAL]; ADIÇÃO DE DEFINIÇÃO ARREDONDADA DE MEDIANA DE COMPLEIÇÃO CASO INDEFINIÇÃO; EXPOSIÇÃO VISUAL DINÂMICA DE MÉTODO DA PRESCRIÇÃO',     
    'TAO 5.2.7': 'ADIÇÃO DE INQUÉRITOS PERSONALIZADOS A WU XING EM CASO DE COMPLEIÇÃO DESCONHECIDA',     
    'TAO 5.2.8': 'AJUSTES DE TABULAÇÕES E MUDANÇAS DE TELA, AJUSTE DE DISPOSIÇÃO DE VALORES COM TEXTOS LONGOS',         
    'TAO 5.2.9': 'AJUSTES DE ERROS DE CLASSIFICAÇÃO DE ALTO/BAIXO/UNICODES NO TEXTO DE EXPOSIÇÃO E AJUSTE DE DETECÇÃO DE DATAS AUTOMÁTICAS PARA IDADE EM INSERÇÃO 10-DÍGIITOS',       
    'TAO 5.3.0': 'CORREÇÃO DE EXPOSIÇÃO DE DADOS REDUNDANTES, AJUSTE DE EXPOSIÇÃO DE NFORMAÇÃO DE TAMANHO DE BANCO DE DADOS COM ARRENDONDAMENTO E BASE EM B/KB/MB/GB, TROCA DE PAINEL DE PROGRESSÃO DA PRESCRIÇÃO E SALVAMENTO',       
}
# ERROS CATALOGADOS [ * 5 6 7 8 9 10 * 30 31 32 33 34 35 * ]
