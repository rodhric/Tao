...
# -------------------------------------- VERIFICAÇÃO DE DIAGNÓSTICO - PARTE 4
        ...
        if len(smt) >= 1:
            for i, j in enumerate(list(smt), start=1):
                print(i, j)
        if len(pool) >= 1:
            print('\n❤  PULSOLOGIA DE '+nome+': '+str(limpar(cata)))      
                    ...
                    if 'FIM' in digpre:
                        ...
                        if homm=='A':
                            ...
                            with open('registro_acupuntura.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)       
                            data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(horadia),str(addr),str(comfx.upper()),str(limpar(pureli)),str(totpul),str(limpar(seta)),str(limpar(pool3)),str(limpar(dxconf)),str(limpar(dxconff)),ver]
                        ...
                        if homm=='D':
                            ...
                            with open('registro_acupuntura.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)       
                            data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(horadia),str(addr),'N/D','N/D','N/D',str(limpar(seta)),str(limpar(pool3)),'N/D','N/D',ver] # anula dxconf e dxconff ao fim
                            with open('ailog.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)        
        ...
        try:
            ...
            if os.path.exists('registro_acupuntura.csv') == True and os.path.exists('ailog.csv') == True and os.path.exists('prontuario.csv') == True:
                ...
                if os.path.exists('ailog.csv') == False:
                    ...
                    time.sleep(1)
                    header=['CPF','NOME','SEXO','IDADE','DATA NASCIMENTO','SUF','DATA DE EMISSÃO','LOCAL DE ATENDIMENTO','COMPLEIÇÃO','LÍNGUA','PULSO','DIAGNÓSTICOS','PRESCRIÇÃO ACUPUNTURA','DIAGNÓSTICOS DIFERENCIAIS','DIAGNÓSTICOS CONFIRMADOS','VERSÃO']
