                ...
                if digprepre.isnumeric() == True:
                    ...
                    if 'FIM' in digpre:
                        ...
                        if homm == 'A':
                            ...
                            print(
                                f'Na sessão foi prescrito os pontos de tratamento: {pool3}, para tanto, utilizando-se como siglas, s:sedação, w:tonificação, q:moxa, z:neutro, y:ventosa, k:sangria, m:dir. unilat., n:esq. unilat.')
                            if len(pool) >= 1:
                                dispo={i.capitalize() for i in pool}
                                print('RITMOS DETECTADOS EM '+nome+':', end='')
                                print(dispo)
                            if len(prepdif) >= 1:
                                print('ANÁLISE DE LÍNGUA EM '+nome+':', end='')
                                print(prepdif)
                            if len(reporth) >= 1:
                                print('RELATOS DE SINTOMAS E CAUSAS:', end='')
                                print(reporth)                                
                            print()
                            print(tabela)
                            print()
