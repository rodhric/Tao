        ...
        try:
            ...
            if rede is True:
                try:
                    ...
                    b2 = a1['temperature']
                    if int(b2)<20:
                        warn_pun.add('⦸ ADIAR SESSÃO DE ACUPUNTURA: TEMPERATURA MUITO BAIXA')
                    if int(b2)>31:
                    ...
                    if int(b1)>90:
                        if shu_h<18 and shu_h>16:
                            ...
                            if int(b3)!=26 and int(b3)!=27 and int(b3)!=28 and int(b3)!=29 and int(b3)!=1 and int(b3)!=2 and int(b3)!=3 and int(b3)!=4:
                                warn_pun.add('⦸ ADIAR SESSÃO DE ACUPUNTURA: LUA OCULTA')
                    if shu_h>16:
                        if shu_h<18:
                            if int(b3)!=26 and int(b3)!=27 and int(b3)!=28 and int(b3)!=29 and int(b3)!=1 and int(b3)!=2 and int(b3)!=3 and int(b3)!=4:
                                warn_pun.add('⚠ EM BREVE POSSÍVEL LUA OCULTA')                                          
            ...
            if os.path.exists('registro_acupuntura.csv') == True and os.path.exists('ailog.csv') == True and os.path.exists('registro_acupuntura.csv') == True and os.path.exists('cadastro.csv') == True:
                ...
                if nu==0:
                    ...
                    if os.path.exists('cadastro.csv') == False:
                        print('✘ BASE DE CADASTRO: INATIVA')
            if rede is True:
                    ...
                    while True:
                        try:
                            ...
                            if pacientecadastrado==True:
                                ...
                                pre_especcodcompa_dn=str(dca['SUF'].values[0])                            
                            elif pacienteantigo==True:
                            ...
                            if os.path.exists('cadastro.csv') == True:
                                if pacientecadastrado == False:
                                    data=["'"+str(cpf)+"'",str(nome),sexo,str(expodn),str(pre_especcodcompa_dn)]
...
def ler():
    ...
    if df.loc[df['CPF'].isin(["'"+str(cpf)+"'"])].empty:
        ...
        print('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n')
        print(f'♻  LEITURA DE PRESCRIÇÃO | {b} - {c}')
...
def ben():
    while True:
        ...
        if len(hda)==0:
            hda='HDA EM BRANCO'
        termoquery = input('\n\nOCORREM SENSAÇÕES DE CALOR, FRIO OU SUOR NAS MÃOS OU PÉS (SEM SER NO CORPO TODO) OU RESSEMCAMENTO DE PELE OU SUOR OU MESMO INCHAÇOS? (S/N) ').upper()
        global h3
        h3 = set()
        if termoquery == 'S':
                ...
                if digprepre.isnumeric() == True:
                    ...
                    if 'FIM' in digpre:
                        ...
                        if homm=='A':
                            ...
                            data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(acompanhante.upper()),str(horadia),str(addr),str(comfx.upper()),str(limpar(pureli)),str(totpul),str(limpar(seta)),str(limpar(pool3)),str(limpar(warn_pun)),str(limpar(questionario)),ver]
                            with open('registro_acupuntura.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)       
                            data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(acompanhante.upper()),str(horadia),str(addr),str(comfx.upper()),str(limpar(pureli)),str(totpul),str(limpar(seta)),str(limpar(pool3)),str(limpar(dxconf)),str(limpar(dxconff)),ver]
                        ...
                        if homm=='D':
                            # ARQUIVAMENTO DE DADOS EM DB
                            data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(acompanhante.upper()),str(horadia),str(addr),'N/D','N/D','N/D',str(limpar(seta)),str(limpar(pool3)),' ',' ',ver] # anula recomendações e métodos (warn_pun e questionario) ao fim
                            with open('registro_acupuntura.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)       
                            data=["'"+str(cpf)+"'",str(nome),sexo,str(idd),str(expodn),str(pre_especcodcompa_dn),str(acompanhante.upper()),str(horadia),str(addr),'N/D','N/D','N/D',str(limpar(seta)),str(limpar(pool3)),'N/D','N/D',ver] # anula dxconf e dxconff ao fim
                            with open('ailog.csv', 'a', encoding='UTF8', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(data)        
        ...
        try:
            ...
            if os.path.exists('registro_acupuntura.csv') == True and os.path.exists('ailog.csv') == True and os.path.exists('prontuario.csv') == True:
                ...
                if os.path.exists('registro_acupuntura.csv') == False:
                    ...
                    time.sleep(1)
                    header=['CPF','NOME','SEXO','IDADE','DATA NASCIMENTO','SUF','ACOMPANHANTE','DATA DE EMISSÃO','LOCAL DE ATENDIMENTO','COMPLEIÇÃO','LÍNGUA','PULSO','DIAGNÓSTICOS','PRESCRIÇÃO ACUPUNTURA','RECOMENDAÇÕES DE TRATAMENTO','MÉTODO','VERSÃO']
                ...
                if os.path.exists('ailog.csv') == False:
                    ...
                    time.sleep(1)
                    header=['CPF','NOME','SEXO','IDADE','DATA NASCIMENTO','SUF','ACOMPANHANTE','DATA DE EMISSÃO','LOCAL DE ATENDIMENTO','COMPLEIÇÃO','LÍNGUA','PULSO','DIAGNÓSTICOS','PRESCRIÇÃO ACUPUNTURA','DIAGNÓSTICOS DIFERENCIAIS','DIAGNÓSTICOS CONFIRMADOS','VERSÃO']
                ...
                if os.path.exists('cadastro.csv') == False:
                    # ARQUIVO PARA IMPLEMENTAÇÃO DE ALGORÍTMO DE ANÁLISE IA
                    print('Criando arquivo de cadastro.csv...')
                    time.sleep(1)
