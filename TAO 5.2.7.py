            ...
            try:
                ...
                if comf == 5:
                    ...
                    if x == "E":
                        perfil[4] += 1
                        sta.append(int(5))
                    ques5 = input("Qual destes fatores apresenta maior aversão ou incômodo? A-Local quente sem ar condicionado B-Saunas/piscinas/estufas/ locais abafados C-Local muito seco D-Local muito frio com ar no máximo E-Ventilador ou o vento do ar condicionado F-Nenhum ").upper()
                    x = ques5
                    if x == "A":
                        perfil[0] += 1
                        sta.append(int(1))
                    ...
                    if x == "E":
                        perfil[4] += 1
                        sta.append(int(5))
                    ques6 = input("Como anda seu comportamento socialmente: A-Muito social; B-Equilibrando/ indiferente; C-Pouco socializável; D-Não perde tempo defendendo opinião e nem briga; E-Indiferente socialmente, porém em conversas opiniões fortes; F-Nenhum ").upper()
                    x = ques6
                    if x == "A":
                        perfil[0] += 1
                        sta.append(int(1))
                    ...
                    if x == "E":
                        perfil[4] += 1
                        sta.append(int(5))
                    ques8 = input("Alguma destas? A-Pensamento incessante até esquece o que pensou, atrapalha sono pensar assim; B-Parece que anda esquecido(a) demais ou anda estudando muito e acha que por isso está esquecido(a); C-Coceiras e alergias recorrentes; D-Desmotivado(a) como antes e nem tem planos a longo prazo (mas não é depressão é desestímulo); E-Alfa! Assume controle da vida, toma responsabilidades e até briga quando as coisas desandam (ou pode ser muito indeciso(a), um ou outro); F-Nenhum ").upper()
                    x = ques8
                    if x == "A":
                        perfil[0] += 1
                        sta.append(int(1))
                    ...
                    while True:
                        try:
                            pre_ques9=input('Preferência por água gelada? A-Sempre B- Tanto faz ou nem gosta ').upper()
                            if pre_ques9=='A':
                                ques9 = input("Qual alimento tem compulsão e prefere? A-Salgados (coxinha/ frituras e bolo salgado); B-Alimentos fortes (limão ou algum alimento que as pessoas assustam); C-Amargos (café, água tônica, ou algum alimento que só a pessoa gosta); D-Doces (balas/ tortas/ biscoitos); E-Picantes (pimentas); F-Nenhum ").upper()
                                warn.add('SINAIS DE CALOR CHEIO DA COMPLEIÇÃO')
                            elif pre_ques9=='B':
                                ques9= input("Qual alimento tem compulsão e prefere? A-Amargos (café, água tônica, ou algum alimento que só a pessoa gosta); B-Doces (balas/ tortas/ biscoitos); C-Picantes (pimentas); D-Salgados (coxinha/ frituras e bolo salgado); E-Alimentos fortes (limão ou algum alimento que as pessoas assustam); F-Nenhum ").upper()
                            else:
                                continue
                            x = ques9
                            if x == "A":
            ...
            if len(seta) < 1:
                ...
                if digprepre.isnumeric() == True:
                    ...
                    if "FIM" in digpre:
                        ...
                        print('[▬▬        ]\n')  
                        print('SEPARANDO GLOBAIS E FUNÇÕES DE AI...')                                               
                        print('\n\n')
                        time.sleep(1.7)                        
                        cls()
                        print("\n\n\n\n SALVANDO EM BANCO DE DADOS...\n\n")
                        ...
                        print("\n\n\n\n SALVANDO EM BANCO DE DADOS...\n\n")
                        print('[▬▬▬▬▬▬▬▬  ]\n')                                                  
                        print('APENDENDO O DIAGNÓSTICO POR AI...')                                               
                        print('\n\n')
                        time.sleep(2.0)                                                                                                        
                        if homm == 'A':
