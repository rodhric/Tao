...
def home():
    while True:
        ...
        x=str('DATA: '+'HORA: '+horadia+' HORA DO SHU ATUAL: ' +shu_agora+'ESTAÇÃO: '+estação)
        valores.append(x)
        shu('')
                        ...
                        if sexo == 'M' or sexo == 'F':
                            while True:
                                try:
                                    ...
                                    dn4 = dtot[5]
                                    str(dn4)
                                    # especial para exportar documento
            ...
            if len(nome) <= 8 or nome.isnumeric() == True or ' ' not in nome:
                ...
                while True:
                    try:
                        ...
                        valores.append('SEXO: '+sexo)
                        if sexo == 'M' or sexo == 'F':
                            idd=int(input('Qual a idade (anos completos)? '))
                            if idd>5 or idd<110:
                                valores.append('IDADE: '+str(idd)+' ANOS')
                                if sexo == 'M':
                                    acompanhante='SEM ACOMPANHANTE'
