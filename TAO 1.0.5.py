...
def ben():
    while True:
        ...
        if 'O' in moradia:
            ...
            warn_pun.add('Insersão em tecido conectivo do osso de junta'.upper())
        if 'J' in moradia:
            warn_pun.add(
        ...
        if 'T' in moradia:
            warn_pun.add('Proximidade em junta com dor ou em IFD/IFP/MCF'.upper())
            warn_pun.add(
                    ...
                    if 'FIM' in digpre:
                        ...
                        if len(digpre) >= 3 and digpre != 'FIM' or len(digpre) < 7:
                            ...
                            if cut[0] == 'G' or cut[0] == 'H' or cut[0] == 'W' or cut[0] == 'X' or cut[0] == 'Y' or cut[0] == 'Z' or cut[0] == 'K' or cut[0] == 'M' or cut[0] == 'N' or cut[0] == 'A' or cut[0] == 'D':
                                ...
                                print('Somente aceito pontos de acupuntura. Tente novamente.')
                                time.sleep(2)
                                continue
                        else:
                            print(
