...
# -------------------------------------- VERIFICAÇÃO DE DIAGNÓSTICO - PARTE 4
        ...
        print(tabela2)
        valores.append('PULSOLOGIA | METAL: '+str(d1a)+'/'+str(d1c)+' TERRA: '+str(d2a)+'/'+str(d2c)+' FOGO MINISTERIAL: '+str(d3a)+'/'+str(d3c)+' FOGO IMPERIAL: '+str(e1a)+'/'+str(e1c)+' MADEIRA: '+str(e2a)+'/'+str(e2c)+' ÁGUA: '+str(e3a)+'/'+str(e3c))
