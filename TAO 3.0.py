                    ...
                    try:
                        ...
                        if len(cep) == 8 and cep.isnumeric() == True:
                            try:
                                ...
                                addr = str(input('Servidor indisponível. Digite endereço do local atual do atendimento: ')).upper()
                                if len(addr)<8:
                                    continue
                        else:
                            addr = str(input('CEP incorreto! Digite endereço do local atual do atendimento: ')).upper()
                            if len(addr)<8:
                                continue
                        if sexo == 'M':
                            global acompanhante
