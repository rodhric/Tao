                ...
                try:
                    ...
                    if shu_h>16:
                        ...
                        if shu_h>18:
                            if int(b3)!=26 or int(b3)!=27 or int(b3)!=28:
                                warn_pun.add('>> LUA OCULTA PARA ACUPUNTURA')
                    c1=f'ENCOBRIMENTO DE CÉU: {b1}%; '
                    c2 = f'TEMPERATURA: {b2}°C; '
                    def traduzir(x): return 'INDISPONÍVEL' if x == 1 else  'ENSOLARADO' if x == 2 else  'PREDOMINANTEMENTE ENSOLARADO' if x == 3 else  'PARCIALMENTE ENSOLARADO' if x == 4 else  'PREDOMINANTEMENTE NUBLADO' if x == 5 else  'NUBLADO' if x == 6 else  'TOTALMENTE NUBLADO' if x == 7 else  'NUBLADO COM NÚVENS BAIXAS' if x == 8 else  'NEBLINA' if x == 9 else  'CHUVA LEVE' if x == 10 else  'CHUVA' if x == 11 else  'CHUVA PARCIAL' if x == 12 else  'CHUVA ENSOLARADA' if x == 13 else  'TEMPESTADE' if x == 14 else  'TEMPESTADES LOCAIS' if x == 15 else  'CHUVA DE GRANIZO' if x == 16 else  'NEVE' if x == 17 else  'POSSIBILIDADE DE NEVE' if x == 18 else  'NEVE' if x == 19 else  'NEVASCA' if x == 20 else  'POSSÍVEL NEVASCA' if x == 21 else  'NEVASCA' if x == 22 else  'CHUVA SÓLIDA' if x == 23 else  'POSSÍVEL CHUVA SÓLIDA' if x == 24 else  'GRANIZO' if x == 25 else  'NOITE CLARA' if x == 26 else  'NOITE PREDOMINANTEMENTE CLARA' if x == 27 else  'NOITE PARCIALMENTE CLARA' if x == 28 else  'NOITE PARCIALMENTE NUBLADA' if x == 29 else  'NOITE NUBLADA' if x == 30 else  'NOITE NUBLADA COM NÚVENS BAIXAS' if x == 31 else  'NOITE CHUVOSA' if x == 32 else  'NOITE COM TEMPESTADES LOCAIS' if x == 33 else  'NOITE DE NEBLINA' if x == 34 else  'NOITE DE NEVE' if x == 35 else  'NOITE DE CHUVA SÓLIDA' if x == 36 else None
                    c3=traduzir(int(b3))
                    z=c1+c2+c3
                    print(z)
                except:
