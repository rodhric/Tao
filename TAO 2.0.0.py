        ...
        try:
            if len(seta) < 1:
                ...
                if len(pool3) == 0:
                    ...
                    #a=[item[1:] for item in pool3 if item not in u]  # teste, contagem de todos exceto extras
                    #v=list(pool3)
                    #w=v-a
                    agu = 2*len(c)
